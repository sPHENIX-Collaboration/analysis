source /opt/sphenix/core/bin/sphenix_setup.csh -n       # sPHENIX environment, if you have not yet run it.
setenv MYINSTALL /direct/phenix+u/kraghav/WORK/analysis/JEWELTest
