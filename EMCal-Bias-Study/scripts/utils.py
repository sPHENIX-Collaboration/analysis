...
f4a = subparser.add_parser('f4a', help='Create condor submission directory for Event Combining.')
f4a.add_argument('-i', '--run-list', type=str, help='Run list', required=True)
f4a.add_argument('-i2', '--calib-dir', type=str, default='/sphenix/lustre01/sphnxpro/physics/emcal/calib', help='Data Directory. Default: /sphenix/lustre01/sphnxpro/physics/emcal/calib')
f4a.add_argument('-e', '--executable', type=str, default='scripts/genEventCombine.sh', help='Job script to execute. Default: scripts/genEventCombine.sh')
f4a.add_argument('-n', '--nSegments', type=int, default=16, help='Number of segments per run to combine. Default: 16')
