...
#+begin_src bash
rm -f bin/analyze-new-response-v2 && make && ./bin/analyze-new-response-v2 scratch/calo-v14/test.list files/05-31-25-run-info.csv files/04-26-25-pulse-width-info-slim.csv  output/updated-Offset-info-v2.root output plots/update-offsets-comparison-v2
#+end_src
