...
** run-LEDs.py Script
*** General Notes
- Only run the ~run-LEDs.py~ script via one of the sebXX machines. Ex: seb00.
...
- Events per run: 1000
#+begin_src bash
/home/phnxrc/anarde/scripts/run-LEDs.py
#+end_src
...
- Events per run: 1000
#+begin_src bash
/home/phnxrc/anarde/scripts/run-LEDs.py --bias-end 1000 --bias-step 500
#+end_src
...
- Events per run: 1000
#+begin_src bash
/home/phnxrc/anarde/scripts/run-LEDs.py --tp-start 28 --tp-end 30
#+end_src
...
- Events per run: 1000
#+begin_src bash
/home/phnxrc/anarde/scripts/run-LEDs.py --tp-start 26 --tp-end 26
#+end_src
...
- Events per run: 1000
#+begin_src bash
/home/phnxrc/anarde/scripts/run-LEDs.py --bias-start -600 --bias-end -600 --tp-start 30 --tp-end 30
#+end_src
