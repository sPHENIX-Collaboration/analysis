...
void runanajpsi()
{
  ...
  sprintf(outfilename,"pions3.root");
  ...
  in->AddFile("/sphenix/sim/sim01/sphnxpro/MDC1/embedpion/embedupsilonDST_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000004-00295.root");
