...
/*      cdean@bnl.gov       */
/* Modified by Reese Boucher*/
/****************************/

// void kf_particle_analysis(vector<string> myInputLists = {"condorJob/fileLists/productionFiles-CHARM-dst_tracks-00000.list"}, const int nEvents = 10)
void kf_particle_analysis(int file_num=1, const int nEvents = 1000)
{

  //std::string inputFile = "DST_TRACKS_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000062-00000.root";
  //std::string inputFile = "DST_TRACKS_pythia8_Charm_3MHz-0000000040-00000.root";
  //std::string inputFile = "DST_TRACKS_pythia8_Charm_3MHz-0000000040-00001.root";

  //          modify macro to wrtie out numbers to filename output
  ...
  char str[500];
  sprintf(str,"DST_TRACKS_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000062-%05d.root",file_num);
  ...
  outputRecoFile = outputRecoDir + str;
  outputEvalFile = outputRecoDir + str;
  ...
  Fun4AllInputManager *input_dst = new Fun4AllDstInputManager("dstTracks");
  input_dst->fileopen(str);
  se->registerInputManager(input_dst);
