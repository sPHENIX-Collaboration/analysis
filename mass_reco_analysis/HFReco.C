...
namespace HeavyFlavorReco
{
  ...
  //string decayDescriptor = "[D0 -> {K0 -> pi^+ pi^-} pi0]cc";  //See twiki on how to set this
  string decayDescriptor = "[K0 -> pi^+ pi^-]cc";  //See twiki on how to set this

  string reconstructionName = "myKshortReco";     //Used for naming output folder, file and nodes
...
void myHeavyFlavorReco()
{
  ...
  bool fixToPV   = true; // primary vertex
  ...
  kfparticle->setMinimumTrackIP(0.02);
