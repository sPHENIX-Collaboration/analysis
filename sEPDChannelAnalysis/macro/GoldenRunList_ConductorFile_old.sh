...
def get_all_run_numbers(cursor):
    ...
    SELECT runnumber
    FROM datasets
    WHERE dsttype='DST_JETCALO_run2pp' and dataset = 'ana446_2024p007'
    GROUP BY runnumber
...
CreateDstList.pl --build ana437 --cdb 2024p007 DST_JETCALO_run2pp --list ../Full_ppGoldenRunList_Version1.list
