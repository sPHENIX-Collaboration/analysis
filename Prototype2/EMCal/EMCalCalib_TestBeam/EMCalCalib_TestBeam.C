...
using namespace std;
 TFile *f_TB=new TFile("output_UIUC_2ndenergyscan_16GeV_2280_hodo_tree10_Jun26.root","RECREATE");
 
//TNtuple *ntupleTruth_TB2=new TNtuple("ntuple","event ntuple","Etotal:Emax:E3by3:E5by5:C1:Veto1:Veto2:Veto3:Veto4"); 

//TNtuple *ntupleTruth_TB3=new TNtuple("ntuple2","event ntuple2","Horz_HODO_R0:Horz_HODO_R1:Horz_HODO_R2:Horz_HODO_R3:Horz_HODO_R4:Horz_HODO_R5:Horz_HODO_R6");

//TNtuple *ntupleTruth_TB4=new TNtuple("ntuple3","event ntuple3","Vert_HODO_R0:Vert_HODO_R1:Vert_HODO_R2:Vert_HODO_R3:Vert_HODO_R4:Vert_HODO_R5:Vert_HODO_R6:Vert_HODO_R7");
...
Float_t sumE=0;
 ...
 Float_t energy_chrenk1=0;
  ...
  //define this later
  Float_t ColumnE_0=abs(towers->getTower(0,0)->get_energy()+ towers->getTower(0,1)->get_energy() +towers->getTower(0,2)->get_energy()+towers->getTower(0,3)->get_energy()+towers->getTower(0,4)->get_energy()+towers->getTower(0,5)->get_energy()+towers->getTower(0,6)->get_energy()+towers->getTower(0,7)->get_energy());
  Float_t ColumnE_1=abs(towers->getTower(1,0)->get_energy()+ towers->getTower(1,1)->get_energy() +towers->getTower(1,2)->get_energy()+towers->getTower(1,3)->get_energy()+towers->getTower(1,4)->get_energy()+towers->getTower(1,5)->get_energy()+towers->getTower(1,6)->get_energy()+towers->getTower(1,7)->get_energy());
  Float_t ColumnE_2=abs(towers->getTower(2,0)->get_energy()+ towers->getTower(2,1)->get_energy() +towers->getTower(2,2)->get_energy()+towers->getTower(2,3)->get_energy()+towers->getTower(2,4)->get_energy()+towers->getTower(2,5)->get_energy()+towers->getTower(2,6)->get_energy()+towers->getTower(2,7)->get_energy());
  Float_t ColumnE_3=abs(towers->getTower(3,0)->get_energy()+ towers->getTower(3,1)->get_energy() +towers->getTower(3,2)->get_energy()+towers->getTower(3,3)->get_energy()+towers->getTower(3,4)->get_energy()+towers->getTower(3,5)->get_energy()+towers->getTower(3,6)->get_energy()+towers->getTower(3,7)->get_energy());
  Float_t ColumnE_4=abs(towers->getTower(4,0)->get_energy()+ towers->getTower(4,1)->get_energy() +towers->getTower(4,2)->get_energy()+towers->getTower(4,3)->get_energy()+towers->getTower(4,4)->get_energy()+towers->getTower(4,5)->get_energy()+towers->getTower(4,6)->get_energy()+towers->getTower(4,7)->get_energy());
  Float_t ColumnE_5=abs(towers->getTower(5,0)->get_energy()+ towers->getTower(5,1)->get_energy() +towers->getTower(5,2)->get_energy()+towers->getTower(5,3)->get_energy()+towers->getTower(5,4)->get_energy()+towers->getTower(5,5)->get_energy()+towers->getTower(5,6)->get_energy()+towers->getTower(5,7)->get_energy());
  Float_t ColumnE_6=abs(towers->getTower(6,0)->get_energy()+ towers->getTower(6,1)->get_energy() +towers->getTower(6,2)->get_energy()+towers->getTower(6,3)->get_energy()+towers->getTower(6,4)->get_energy()+towers->getTower(6,5)->get_energy()+towers->getTower(6,6)->get_energy()+towers->getTower(6,7)->get_energy());
  Float_t ColumnE_7=abs(towers->getTower(7,0)->get_energy()+ towers->getTower(7,1)->get_energy() +towers->getTower(7,2)->get_energy()+towers->getTower(7,3)->get_energy()+towers->getTower(7,4)->get_energy()+towers->getTower(7,5)->get_energy()+towers->getTower(7,6)->get_energy()+towers->getTower(7,7)->get_energy());

  Float_t RowE_0=abs(towers->getTower(0,0)->get_energy()+ towers->getTower(1,0)->get_energy() +towers->getTower(2,0)->get_energy()+towers->getTower(3,0)->get_energy()+towers->getTower(4,0)->get_energy()+towers->getTower(5,0)->get_energy()+towers->getTower(6,0)->get_energy()+towers->getTower(7,0)->get_energy());
  Float_t RowE_1=abs(towers->getTower(0,1)->get_energy()+ towers->getTower(1,1)->get_energy() +towers->getTower(2,1)->get_energy()+towers->getTower(3,1)->get_energy()+towers->getTower(4,1)->get_energy()+towers->getTower(5,1)->get_energy()+towers->getTower(6,1)->get_energy()+towers->getTower(7,1)->get_energy());
  Float_t RowE_2=abs(towers->getTower(0,2)->get_energy()+ towers->getTower(1,2)->get_energy() +towers->getTower(2,2)->get_energy()+towers->getTower(3,2)->get_energy()+towers->getTower(4,2)->get_energy()+towers->getTower(5,2)->get_energy()+towers->getTower(6,2)->get_energy()+towers->getTower(7,2)->get_energy());
  Float_t RowE_3=abs(towers->getTower(0,3)->get_energy()+ towers->getTower(1,3)->get_energy() +towers->getTower(2,3)->get_energy()+towers->getTower(3,3)->get_energy()+towers->getTower(4,3)->get_energy()+towers->getTower(5,3)->get_energy()+towers->getTower(6,3)->get_energy()+towers->getTower(7,3)->get_energy());
  Float_t RowE_4=abs(towers->getTower(0,4)->get_energy()+ towers->getTower(1,4)->get_energy() +towers->getTower(2,4)->get_energy()+towers->getTower(3,4)->get_energy()+towers->getTower(4,4)->get_energy()+towers->getTower(5,4)->get_energy()+towers->getTower(6,4)->get_energy()+towers->getTower(7,4)->get_energy());
  Float_t RowE_5=abs(towers->getTower(0,5)->get_energy()+ towers->getTower(1,5)->get_energy() +towers->getTower(2,5)->get_energy()+towers->getTower(3,5)->get_energy()+towers->getTower(4,5)->get_energy()+towers->getTower(5,5)->get_energy()+towers->getTower(6,5)->get_energy()+towers->getTower(7,5)->get_energy());
  Float_t RowE_6=abs(towers->getTower(0,6)->get_energy()+ towers->getTower(1,6)->get_energy() +towers->getTower(2,6)->get_energy()+towers->getTower(3,6)->get_energy()+towers->getTower(4,6)->get_energy()+towers->getTower(5,6)->get_energy()+towers->getTower(6,6)->get_energy()+towers->getTower(7,6)->get_energy());
  Float_t RowE_7=abs(towers->getTower(0,7)->get_energy()+ towers->getTower(1,7)->get_energy() +towers->getTower(2,7)->get_energy()+towers->getTower(3,7)->get_energy()+towers->getTower(4,7)->get_energy()+towers->getTower(5,7)->get_energy()+towers->getTower(6,7)->get_energy()+towers->getTower(7,7)->get_energy());
  ...
  /* cout<<"Veto :"<<Veto_Trig0<<endl;
  cout<<"Veto :"<<Veto_Trig1<<endl;
  cout<<"Veto :"<<Veto_Trig2<<endl;
  cout<<"Veto :"<<Veto_Trig3<<endl;
  */
 ...
 SaveVert_TowerID7_t=SaveVert_TowerID7;
    ...
    /* cout<<"C2 inner (0)  :"<<towers_sub2->getTower(0)->get_energy()<<endl;
    cout<<"C2 outer (1)  :"<<towers_sub2->getTower(1)->get_energy()<<endl;
    cout<<"C2 inner (11) :"<<towers_sub2->getTower(10)->get_energy()<<endl;
    cout<<"C2 outer (10) :"<<towers_sub2->getTower(11)->get_energy()<<endl;
    cout<<endl;*/
...
//for 3by3 array
 ...
 //pass through data to grab column info
 // for (int i=0;i<8;i++)
 //	Tower_column_t=towers_sub3->getTower(0,0)->get_id();
...
//2nd loop through the data with Emax
 ...
 //cout<<"C2 2 is :"<<energy_chrenk2_C2_2<<endl;
 //cout<<"C2 3 is :"<<energy_chrenk2_C2_3<<endl;
