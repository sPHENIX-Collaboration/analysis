...
class ParticleFlowElementv1 : public ParticleFlowElement
{
 public:
  ...
  std::vector<SvtxTrack*> get_assoc_tracks() const override { return _assoc_tracks; }
  void set_assoc_tracks(const std::vector<SvtxTrack*>& ecluster) override { _assoc_tracks = ecluster; }
 ...
 private:
  ...
  std::vector<SvtxTrack*> _assoc_tracks;
