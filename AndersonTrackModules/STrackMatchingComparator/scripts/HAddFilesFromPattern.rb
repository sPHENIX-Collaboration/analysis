...
# input parameters
in_path = "./old_eval/num1evt500pt10pim_oneMatchPerParticle"
in_pref = "/sPhenixG4_oneMatchPerParticle*"
in_suff = ".root"

# output parameters
out_file = "sPhenixG4_oneMatchPerParticle.pt10num1evt500pim.d18m1y2024.root"
