...
#include <laserclusterqa/laserQA_multiple.h>
...

{
  ...
  */
  ...
  laserQA_multiple *lcQA = new laserQA_multiple("laserClusterQA");
  lcQA->setOutfile(Form("%s/laserHitQA_%s_%s-%08d.root",outdir.c_str(),type.c_str(),prod.c_str(),runnumber));
