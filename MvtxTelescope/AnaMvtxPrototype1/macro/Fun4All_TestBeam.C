...
void Fun4All_TestBeam(int nEvents = 5,
                      const char *input_file = "./beamtest2018/beam/beam_00000015-0000.prdf",
                      const char *output_file = "beam_00000015.root"
                     )
{
  ...
  */
  ...
  MvtxApplyHotDead *hotdead = new MvtxApplyHotDead("MvtxApplyHotDead",
      "/phenix/u/dcm07e/sPHENIX/analysis/MvtxTelescope/AnaTestbeamV1/hotmap/hotmap_testbeam.txt");
  hotdead->Verbosity(0);
  ...
  // ana->MisalignLayer(0, +38, 0, +4);
  // ana->MisalignLayer(1, +26, 2.2 / 28e-4, +8);
  // ana->MisalignLayer(2, +12, 4.4 / 28e-4, +13);
  // ana->MisalignLayer(3, 0, 6.6 / 28e-4, 0);
  ana->Verbosity(0);
