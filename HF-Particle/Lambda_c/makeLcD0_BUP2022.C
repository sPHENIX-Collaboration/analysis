...
const double AuAu_Ncoll_C0_100 = 238.5;  // BUP2022
const double pAu_Ncoll_C0_100 = 4.7;     // pb^-1 [sPH-TRG-000]

const double AuAu_rec_3year = (5.7 + 15) * 1e9;       // BUP2022
const double AuAu_rec_5year = AuAu_rec_3year + 30e9;  // BUP2022

const double pp_inelastic_crosssec = 42e-3;        // 42 mb [sPH-TRG-000]
const double pp_rec_3year = 6.2e12;                // BUP2022
const double pp_rec_5year = pp_rec_3year + 80e12;  // BUP2022
const double pp_beam_pol = 0.57;

const double OO_rec_5year = 37e9;              // BUP2022
const double OO_Ncoll_C0_100 = 9.6;            // BUP2022
const double OO_inelastic_crosssec = 1.12214;  // BUP2022

const double ArAr_rec_5year = 12e9;             // BUP2022
const double ArAr_Ncoll_C0_100 = 28.5;          // BUP2022
const double ArAr_inelastic_crosssec = 2.3423;  // BUP2022

void makeLcD0_BUP2022()
{
  ...
  */
  ...
  TCanvas *c1 = new TCanvas("Lc_BUP2022_AuAu_3yr", "Lc_BUP2022_AuAu_3yr", 1100, 800);
  c1->Divide(1, 1);
  int idx = 1;
  TPad *p;
  ...
  p->DrawFrame(0, 0, 11, 6)->SetTitle(";#it{p}_{T} [GeV];(#Lambda_{c}^{+}+#bar{#Lambda}_{c}^{-})/(D^{0}+#bar{D}^{0})");
...
//  tex->SetTextSize(0.055);
  ...
  leg->SetFillStyle(0);
  leg->AddEntry("", "#it{#bf{sPHENIX}} BUP 2022, Years 1-3", "");
...
//  leg->SetTextFont(6);
  ...
  leg = new TLegend(0.5, 0.35, 0.94, 0.5);
//  leg->SetFillColor(10);
//  leg->SetFillStyle(10);
