...
void Fun4All_VandySkimmer(const std::string caloDSTlist, const std::string jetDSTlist, const std::string outDir = "/sphenix/tg/tg01/jets/bkimelman/wEEC/")
{
  ...
  vs->SetOutfileName(std::format("{}/VandyDSTs_run2pp_ana521_2025p007_v001-{}.root",outDir, runnumber).c_str());
  vs->SetDoSim(doSim);
