...
int Fun4All_G4_sPHENIX_Photons(
		       const int nEvents = 1,
		       const int jobnum=0,
		       // const char * inputFile = "/phenix/upgrades/decadal/dvp/GeneratorInputFiles/PhotonJet/hepmc_pTHatMin25PromptPhotonall_photontrig30eta0to1_jettrig20eta0to0p6_00000_01000.dat",
		       const char *inputFile = "/sphenix/sim/sim01/production/photonjet/2017-01-10/G4Hits_pTHatMin25PromptPhotonall_photontrig30eta0to1_jettrig20eta0to0p6_00000_00100.root",
		       ...
		       )
{
  ...
  bool do_phot_jet_eval = false;
  bool do_phot_eval = true;
  ...
  if (do_phot_jet_eval){
    ...
    photjet->Set_Isocone_radius(0.3);
    photjet->set_cluspt_mincut(10.);
    photjet->use_isocone_algorithm(0);
    photjet->set_jetcone_size(0.2);
