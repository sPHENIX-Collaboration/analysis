...
TruthPhotonJet::TruthPhotonJet(const std::string &name) : SubsysReco("TRUTHPHOTONJET")
{
  initialize_values();
...
void TruthPhotonJet::GetRecoHadronsAndJets(RawCluster *trig,
				      SvtxTrackMap *tracks,
				      JetMap *jets,
				      JetMap *trackedjets,
...
float TruthPhotonJet::ConeSum(RawCluster *cluster, 
