...
void Lambda_Kshort_ratio_NN()
{
  ...
  TFile* Ks_file = TFile::Open("/sphenix/user/aopatton/MomentumScaleStudies/scalePlusKFP/output/pipiSegNewMap_79528.root");
  TFile* lambda_file = TFile::Open("/sphenix/user/aopatton/MomentumScaleStudies/scalePlusKFP/output/ppiSegNewMap_79528.root");
