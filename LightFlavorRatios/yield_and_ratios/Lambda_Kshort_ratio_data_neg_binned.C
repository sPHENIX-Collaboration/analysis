...
void Lambda_Kshort_ratio_data_neg_binned()
{
  TFile* lambda_file = TFile::Open("/sphenix/user/mjpeters/analysis/LightFlavorRatios/mass_histograms/Lambda_data_neg.root");
  ...
  TFile* fout = new TFile("fits_neg.root","RECREATE");
