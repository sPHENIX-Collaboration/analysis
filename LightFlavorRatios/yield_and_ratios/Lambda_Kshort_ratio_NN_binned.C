...
void Lambda_Kshort_ratio_NN_binned()
{
  TFile* lambda_file = TFile::Open("/sphenix/user/mjpeters/analysis/LightFlavorRatios/mass_histograms/Lambda_NN_data.root");
  ...
  TFile* fout = new TFile("fits_NN.root","RECREATE");
