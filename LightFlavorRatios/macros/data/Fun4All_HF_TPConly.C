...
#include "HF_selections_TPConly.C"
...
void Fun4All_HF_TPConly(const int nEvents = -1,
                const std::string inputDST = "/sphenix/lustre01/sphnxpro/production/run3pp/physics/ana538_2025p011_v001/DST_TRKR_SEED/run_00079500_00079600/DST_TRKR_SEED_run3pp_ana538_2025p011_v001-00079516-01995.root", //         
                ...
                const bool convertSeeds = true)                                                                                                                                                                                    //
{
    ...
    if (!DoSeeding && (get_dEdx_info || get_detector_info))
    {
        ...
        std::string clus_anacdbver = "ana538_2025p011_v001";
    ...
    */
    ...
    if (DoFitting)
    {
        if(!convertSeeds) Tracking_Reco_TrackMatching_run2pp();
        ...
        if (G4TRACKING::convert_seeds_to_svtxtracks)
        {
            ...
            findertpc->Verbosity(0);
            findertpc->setDcaCut(1.5);
            findertpc->setTrackPtCut(0.16);
            findertpc->setBeamLineCut(1);
            findertpc->setBeamSpotCutX(-2.,2.);
            findertpc->setBeamSpotCutY(-2.,2.);
            findertpc->setTrackQualityCut(3000);
            // findertpc->setNmvtxRequired(3);
            findertpc->setRequireMVTX(false);
            findertpc->setOutlierPairCut(1.5);
            //findertpc->setTrackMapName("TpcSvtxTrackMap");
            //findertpc->setVertexMapName("TpcSvtxVertexMap");
            se->registerSubsystem(findertpc);
/*
...
*/
   ...
   // const std::string kappaLookup = "/sphenix/user/aopatton/MomentumScaleStudies/CalibrationsV2/kappa_lookup_79528.csv";
    //const std::string kappaLookup = "/sphenix/user/aopatton/MomentumScaleStudies/Calibrations_pT/kappa_lookup_79526.csv";
    
    const std::string kappaLookup = "/sphenix/user/aopatton/MomentumScaleStudies/Calibrations_compare/kappa_lookup_79528_pt.csv";
/*    
    //new module here
    ...
    momScale->setKappaLookupFile(kappaLookup);
    //momScale->setInputTrackMapName("SvtxTrackMap");
    //momScale->setOutputTrackMapName("SvtxTrackMapMomentumScaleCorrected");
