...
{
  TFile* Ks_file = TFile::Open("/sphenix/tg/tg01/hf/aopatton/Aug7_scaleMapOutputs_pT/scaledOutputLogMaps/pipi_logpt_6_runs.root");
  TFile* lambda_file = TFile::Open("/sphenix/tg/tg01/hf/aopatton/Aug7_scaleMapOutputs_pT/scaledOutputLogMaps/ppi_logpt_6_runs.root");
  ...
  TFile* Ks_outfile = new TFile("/sphenix/tg/tg01/hf/mjpeters/LightFlavorProduction/bcoSkimmedDataSample/pipi_NNcorrected_79528_bco_skimmed.root","RECREATE");
  TTree* ks_outtree = (TTree*)ks_tree->CloneTree(0);

  TFile* lambda_outfile = new TFile("/sphenix/tg/tg01/hf/mjpeters/LightFlavorProduction/bcoSkimmedDataSample/ppi_NNcorrected_79528_bco_skimmed.root","RECREATE");
