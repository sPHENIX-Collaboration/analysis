...
void CutEfficiency_systematics(const std::string& numerator_name = "Lambda0",
                               ...
                               const std::string& max_outfile = "test_max.root")
{
  ...
  PVSVUncertainty numerator_pvsv(infile,numerator_name+"_truth");
  PVSVUncertainty denominator_pvsv(infile,denominator_name+"_truth");
