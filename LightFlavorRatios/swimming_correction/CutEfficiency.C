...
void CutEfficiency()
{
  ...
  */
  ...
  std::string truthDataCut = "((abs(track_1_true_ID) == 211 && abs(track_2_true_ID) == 2212) || (abs(track_1_true_ID) == 2212 && abs(track_2_true_ID) == 211)) && Sum$(abs(track_1_true_track_history_PDG_ID) == 3122) > 0 && Sum$(abs(track_2_true_track_history_PDG_ID) == 3122) > 0 && abs(Lambda0_rapidity) <= 1.0 && track_1_MVTX_nHits > 0 && track_2_MVTX_nHits > 0 && abs(primary_vertex_z) < 10 && track_1_INTT_nHits > 0 && track_2_INTT_nHits > 0 && track_1_TPC_nHits > 19 && track_2_TPC_nHits > 19 && (track_1_chi2/track_1_nDoF) <= 300 && (track_2_chi2/track_2_nDoF) <= 300 && abs(track_1_IP_xy) >= 0.01 && abs(track_2_IP_xy) >= 0.01 && Lambda0_DIRA >= 0.98 && abs(Lambda0_mass - 1.115) <= 0.1 && track_1_track_2_DCA_xy < 1.25 && track_1_track_2_DCA < 0.75 && track_1_pT >= 0.2 && track_2_pT >= 0.2";

  std::string truthDataCut_min = "((abs(track_1_true_ID) == 211 && abs(track_2_true_ID) == 2212) || (abs(track_1_true_ID) == 2212 && abs(track_2_true_ID) == 211)) && Sum$(abs(track_1_true_track_history_PDG_ID) == 3122) > 0 && Sum$(abs(track_2_true_track_history_PDG_ID) == 3122) > 0 && abs(Lambda0_rapidity) <= 1.0 && track_1_MVTX_nHits > 0 && track_2_MVTX_nHits > 0 && abs(primary_vertex_z) < 10 && track_1_INTT_nHits > 0 && track_2_INTT_nHits > 0 && track_1_TPC_nHits > 19 && track_2_TPC_nHits > 19 && (track_1_chi2/track_1_nDoF) <= 300 && (track_2_chi2/track_2_nDoF) <= 300 && (abs(track_1_IP_xy) - " + std::to_string(Lambda_PV_sigma_xy) + " - " + std::to_string(Lambda_track_1_sigma_xy) + ") >= 0.01 && (abs(track_2_IP_xy) - " + std::to_string(Lambda_PV_sigma_xy) + " - " + std::to_string(Lambda_track_2_sigma_xy) + ") >= 0.01 && (track_1_track_2_DCA + " + std::to_string(Lambda_track_1_sigma) + " + " + std::to_string(Lambda_track_2_sigma) + ") <= 0.75 && (track_1_track_2_DCA_xy + " + std::to_string(Lambda_track_1_sigma_xy) + " + " + std::to_string(Lambda_track_2_sigma_xy) + ") <= 1.25 && cos(acos(Lambda0_DIRA) + atan(" + std::to_string(Lambda_PV_sigma) + "/Lambda0_decayLength) + atan(" + std::to_string(Lambda_SV_sigma) + "/Lambda0_decayLength)) >= 0.98 && abs(Lambda0_mass - 1.115) <= 0.1 && track_1_pT >= 0.2 && track_2_pT >= 0.2";
  ...
  std::string truthDataCut_KS0 = "abs(track_1_true_ID) == 211 && Sum$(abs(track_1_true_track_history_PDG_ID) == 310) > 0 && abs(track_2_true_ID) == 211 && Sum$(abs(track_2_true_track_history_PDG_ID) == 310) > 0 && abs(K_S0_rapidity) <= 1.0 && track_1_MVTX_nHits > 0 && track_2_MVTX_nHits > 0 && abs(primary_vertex_z) < 10 && track_1_INTT_nHits > 0 && track_2_INTT_nHits > 0 && track_1_TPC_nHits > 19 && track_2_TPC_nHits > 19 && (track_1_chi2/track_1_nDoF) <= 300 && (track_2_chi2/track_2_nDoF) <= 300 && abs(track_1_IP_xy) >= 0.01 && abs(track_2_IP_xy) >= 0.01 && K_S0_DIRA >= 0.98 && abs(K_S0_mass - 0.5) <= 0.1 && track_1_track_2_DCA_xy <= 1.25 && track_1_track_2_DCA <= 0.75 && track_1_pT >= 0.2 && track_2_pT >= 0.2";
  std::string truthDataCut_KS0_min = "abs(track_1_true_ID) == 211 && Sum$(abs(track_1_true_track_history_PDG_ID) == 310) > 0 && abs(track_2_true_ID) == 211 && Sum$(abs(track_2_true_track_history_PDG_ID) == 310) > 0 && abs(K_S0_rapidity) <= 1.0 && track_1_MVTX_nHits > 0 && track_2_MVTX_nHits > 0 && abs(primary_vertex_z) < 10 && track_1_INTT_nHits > 0 && track_2_INTT_nHits > 0 && track_1_TPC_nHits > 19 && track_2_TPC_nHits > 19 && (track_1_chi2/track_1_nDoF) <= 300 && (track_2_chi2/track_2_nDoF) <= 300 && (abs(track_1_IP_xy) - " + std::to_string(KS0_PV_sigma_xy) + " - " + std::to_string(KS0_track_1_sigma_xy) + ") >= 0.01 && (abs(track_2_IP_xy) - " + std::to_string(KS0_PV_sigma_xy) + " - " + std::to_string(KS0_track_2_sigma_xy) + ") >= 0.01 && (track_1_track_2_DCA + " + std::to_string(KS0_track_1_sigma) + " + " + std::to_string(KS0_track_2_sigma) + ") <= 0.75 && (track_1_track_2_DCA_xy + " + std::to_string(KS0_track_1_sigma_xy) + " + " + std::to_string(KS0_track_2_sigma_xy) + ") <= 1.25 && cos(acos(K_S0_DIRA) + atan(" + std::to_string(KS0_PV_sigma) + "/K_S0_decayLength) + atan(" + std::to_string(KS0_SV_sigma) + "/K_S0_decayLength)) >= 0.98 && abs(K_S0_mass - 0.5) <= 0.1 && track_1_pT >= 0.2 && track_2_pT >= 0.2";
