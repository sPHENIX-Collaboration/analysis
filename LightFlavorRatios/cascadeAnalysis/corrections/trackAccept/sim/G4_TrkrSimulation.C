...
void Intt_Cells()
{
  ...
  reco->setLocalHotStripMaskFile("/sphenix/user/rosstom/analysis/LightFlavorRatios/bachelor_pi_efficiency/sim/deadMaps/simulation_inttdeadmap79563.root");
...
void TPC_Cells()
{
  ...
  */
  ...
  padplane->SetMaskChannelsFromFile();
  padplane->SetDeadChannelMapName("/sphenix/user/rosstom/analysis/LightFlavorRatios/bachelor_pi_efficiency/sim/deadMaps/TPCDeadMap_79563.root");
  padplane->SetHotChannelMapName("/sphenix/user/rosstom/analysis/LightFlavorRatios/bachelor_pi_efficiency/sim/deadMaps/TPCHotMap_79563.root");
