...
void geoAccPlots()
{
   TFile* geoAccFile = TFile::Open("/sphenix/user/rosstom/analysis/LightFlavorRatios/geometric_acceptance/analysis/plots_evaluator/geometricAcceptanceEfficiencyCorrections.root", "READ");

   TH1F* h_pT_KS0 = (TH1F*)geoAccFile->Get("h_geoAccEff_pT_KS0");
   TH1F* h_pT_Xi = (TH1F*)geoAccFile->Get("h_geoAccEff_pT_Xi");
   TH1F* h_eta_KS0 = (TH1F*)geoAccFile->Get("h_geoAccEff_eta_KS0");
   TH1F* h_eta_Xi = (TH1F*)geoAccFile->Get("h_geoAccEff_eta_Xi");
   TH1F* h_phi_KS0 = (TH1F*)geoAccFile->Get("h_geoAccEff_phi_KS0");
   TH1F* h_phi_Xi = (TH1F*)geoAccFile->Get("h_geoAccEff_phi_Xi");
   TH1F* h_rap_KS0 = (TH1F*)geoAccFile->Get("h_geoAccEff_rap_KS0");
   TH1F* h_rap_Xi = (TH1F*)geoAccFile->Get("h_geoAccEff_rap_Xi");
   ...
   //pT Figure
   h_ratio_pT->GetYaxis()->SetTitle("Geo. Acc. and Eff. Ratio");
   h_ratio_pT->GetXaxis()->SetTitle("Mother p_{T} [GeV/c]");
   h_ratio_pT->SetMaximum(0.1);
   ...
   c1->SaveAs("geoAccEff_pT.png"); 
   c1->Close();   

   //eta Figure
   h_ratio_eta->GetYaxis()->SetTitle("Geo. Acc. and Eff. Ratio");
   h_ratio_eta->GetXaxis()->SetTitle("Mother #eta");
   h_ratio_eta->SetMaximum(0.1);
   ...
   c2->SaveAs("geoAccEff_eta.png");
   c2->Close(); 

   //phi Figure
   h_ratio_phi->GetYaxis()->SetTitle("Geo. Acc. and Eff. Ratio");
   h_ratio_phi->GetXaxis()->SetTitle("Mother #phi [rad]");
   h_ratio_phi->SetMaximum(0.1);
   ...
   c3->SaveAs("geoAccEff_phi.png");
   c3->Close(); 

   //rap Figure
   h_ratio_rap->GetYaxis()->SetTitle("Geo. Acc. and Eff. Ratio");
   h_ratio_rap->GetXaxis()->SetTitle("Mother Rapidity");
   h_ratio_rap->SetMaximum(0.1);
