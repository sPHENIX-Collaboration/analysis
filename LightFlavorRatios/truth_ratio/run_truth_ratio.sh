...
root -l calculate_truth_ratio.C\($LAMBDA_FLAVOR,$LAMBDA_MASS,$LAMBDA_DAUGHTERS,$KS_FLAVOR,$KS_MASS,$KS_DAUGHTERS,\"\#Lambda\",\"K^{0}_{S}\",\"$LAMBDA_FILEBASE\",\"$KS_FILEBASE\",0.5,\"output/truth_ratio\",${PROCESS}\)
