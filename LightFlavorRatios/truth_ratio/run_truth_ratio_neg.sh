...
for i in {0..0}
do
	root -l -q -b calculate_truth_ratio.C\($LAMBDA_FLAVOR,$LAMBDA_MASS,$LAMBDA_DAUGHTERS,$KS_FLAVOR,$KS_MASS,$KS_DAUGHTERS,\"\#bar{\#Lambda}\",\"K^{0}_{S}\",\"$LAMBDA_FILEBASE\",\"$KS_FILEBASE\",1.,\"output/truth_ratio_neg\",$((10*PROCESS+$i)),false\)
done
