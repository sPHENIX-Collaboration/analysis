...
{
   fFisher0 = -0.0844739600992;
   fFisherCoefficients.push_back( -1.43051579213 );
   fFisherCoefficients.push_back( -0.269539620647 );
   fFisherCoefficients.push_back( 0.402262492209 );
   fFisherCoefficients.push_back( 0.114840085395 );
   fFisherCoefficients.push_back( -0.0512308893762 );
   fFisherCoefficients.push_back( 0.0867003372772 );
   fFisherCoefficients.push_back( -0.312953668051 );
   fFisherCoefficients.push_back( -0.00686129058321 );
   fFisherCoefficients.push_back( 0.000764347437541 );
   fFisherCoefficients.push_back( -0.614808771127 );
