...
{
   fFisher0 = -0.933035531914;
   fFisherCoefficients.push_back( -0.529056640195 );
   fFisherCoefficients.push_back( -0.407603190442 );
   fFisherCoefficients.push_back( 0.609553977171 );
   fFisherCoefficients.push_back( 0.0990456190937 );
   fFisherCoefficients.push_back( -0.0417020259433 );
   fFisherCoefficients.push_back( 0.0258428826427 );
   fFisherCoefficients.push_back( -0.382545997344 );
   fFisherCoefficients.push_back( -0.002050171128 );
   fFisherCoefficients.push_back( 0.000146035666511 );
   fFisherCoefficients.push_back( 0.40133263382 );
