...
#include <tracksinjets/StructureinJets.h>
//#include </sphenix/u/jamesj3j3/analysis/JS-Jet/StructureinJets/src/StructureinJets.h>
...
void Fun4All_StructureinJets(const char *filelisttrk = "dst_tracks.list",
		    ...
		    const char *outname = "outputest.root")
{
  ...
  StructureinJets *trksinjets = new StructureinJets("AntiKt_Tower_r04_Sub1", outname);
