                     ...
                     const char *outname = "outputest.root")
{
  ...
  towerjetreco->add_algo(new FastJetAlgoSub(Jet::ANTIKT, 0.6, 1), "AntiKt_Tower_r06_Sub1");
  towerjetreco->set_algo_node("ANTIKT");
  towerjetreco->set_input_node("TOWER");
  towerjetreco->Verbosity(verbosity);
  se->registerSubsystem(towerjetreco);
  ...
  std::string recoNameR02 = "AntiKt_Tower_r02_Sub1";
  std::string recoNameR04 = "AntiKt_Tower_r04_Sub1";
  std::string recoNameR06 = "AntiKt_Tower_r06_Sub1";


  JetNconstituent *myJetNconst = new JetNconstituent(recoNameR02, recoNameR04, recoNameR06, outname);
