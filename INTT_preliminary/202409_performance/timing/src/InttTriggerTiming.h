...
class InttTriggerTiming : public SubsysReco
{
private:
  ...
  std::string output_basename_ = "InttTriggerTiming_run";
  std::string output_root_ = "";
  std::string output_txt_ = "";
  TFile* tf_output_;
  
  // objects to be output
  TH1D* hist_bco_diff_; // no ADC0
  TH1D* hist_bco_diff_raw_; // includes all hits
...
public:
  ...
  InttTriggerTiming(const std::string &name = "InttTriggerTiming" );

  ~InttTriggerTiming() override;
