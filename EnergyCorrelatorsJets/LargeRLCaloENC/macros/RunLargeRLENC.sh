...
#/cvmfs/sphenix.sdcc.bnl.gov/gcc-12.1.0/opt/sphenix/core/root-6.26.06.p01/bin/root.exe -x /sphenix/user/sgross/sphenix_analysis/EnergyCorrelatorsJets/LargeRLCaloENC/macros/RunLargeRLENC.C\(\"$data_dst\",\"$data_fitting_dst\",\"$data_trigger_dst\",\"$data_jet_dst\",\"$truth_jet_dst\",\"$calo_reco_dst\",\"$truth_dst\",\"$truth_reco_dst\",\"$global_reco_dst\",\"$runs\",\"$minpt\"\)
