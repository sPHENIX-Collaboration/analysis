...
ALL_TARGETS = bin/Fun4All_sEPD bin/Fun4All_Jet bin/display bin/displayHotMap bin/checkCDB
...
bin/displayHotMap: macros/displayHotMap.C
	@echo "Building $@ from $<"
	mkdir -p bin
	$(CXX) $(CXXFLAGS) $(ALL_CPPFLAGS) -o $@ $< $(ROOT_LIBFLAGS) $(sPHENIX_LIBFLAGS) -lcdbobjects
