...
TrackProjector::TrackProjector( PHCompositeNode *topNode ) :
  _fitter(nullptr)
{
...
bool
TrackProjector::get_projected_position(  SvtxTrack * track, double arr_pos[3], const PROJECTION_SURFACE surf, const float surface_par )
{
...
bool
TrackProjector::get_projected_momentum(  SvtxTrack * track, double arr_mom[3], const PROJECTION_SURFACE surf, const float surface_par )
{
...
SvtxTrackState*
TrackProjector::project_track(  SvtxTrack * track, const PROJECTION_SURFACE surf, const float surface_par )
{
  /* Do projection */
