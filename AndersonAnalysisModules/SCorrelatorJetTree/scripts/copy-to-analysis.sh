...
files_to_copy[12]="src/SCorrelatorJetTree.system.h"
files_to_copy[13]="src/SCorrelatorJetTreeLinkDef.h"
files_to_copy[14]="src/SCorrelatorJetTree.constituents.h"
files_to_copy[15]="src/autogen.sh"
files_to_copy[16]="src/configure.ac"
files_to_copy[17]="src/Makefile.am"
