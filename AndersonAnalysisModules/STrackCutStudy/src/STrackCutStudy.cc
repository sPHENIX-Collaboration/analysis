...
void STrackCutStudy::InitHists() {
  ...
  hTrackVx               = new TH1D("hTrackVx",              "Track v_{x}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hTrackVy               = new TH1D("hTrackVy",              "Track v_{y}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hTrackVz               = new TH1D("hTrackVz",              "Track v_{z}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  ...
  hTruthVx               = new TH1D("hTruthVx",              "Truth v_{x}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hTruthVy               = new TH1D("hTruthVy",              "Truth v_{y}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hTruthVz               = new TH1D("hTruthVz",              "Truth v_{z}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  ...
  hTruthVsTrackVx        = new TH2D("hTruthVsTrackVx",       "Truth v_{x} vs. track v_{x}",                   nVtxBins,  rVtxBins[0],  rVtxBins[1],  nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hTruthVsTrackVy        = new TH2D("hTruthVsTrackVy",       "Truth v_{y} vs. track v_{y}",                   nVtxBins,  rVtxBins[0],  rVtxBins[1],  nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hTruthVsTrackVz        = new TH2D("hTruthVsTrackVz",       "Truth v_{z} vs. track v_{z}",                   nVtxBins,  rVtxBins[0],  rVtxBins[1],  nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  ...
  hDiffVsTruthEta        = new TH2D("hDiffVsTruthEta",       "#varsigma#eta^{trk} vs. #eta^{truth}",          nEtaBins,  rEtaBins[0],  rEtaBins[1],  nDiffBins, rDiffBins[0], rDiffBins[1]);
  hDiffVsTruthPhi        = new TH2D("hDiffVsTruthPhi",       "#varsigma#phi^{trk} vs. #phi^{truth}",          nPhiBins,  rPhiBins[0],  rPhiBins[1],  nDiffBins, rDiffBins[0], rDiffBins[1]);
  hDiffVsTruthPt         = new TH2D("hDiffVsTruthPt",        "#varsigmap_{T}^{trk} vs. truth p_{T}",          nPtBins,   rPtBins[0],   rPtBins[1],   nDiffBins, rDiffBins[0], rDiffBins[1]);
  ...
  hFracPtVsQuality       = new TH2D("hFracPtVsQuality",      "p_{T}^{trk}/p_{T}^{truth} vs. #chi^{2}/ndf",    nQualBins, rQualBins[0], rQualBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  ...
  hWeirdVx               = new TH1D("hWeirdVx",              "Weird v_{x}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hWeirdVy               = new TH1D("hWeirdVy",              "Weird v_{y}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hWeirdVz               = new TH1D("hWeirdVz",              "Weird v_{z]",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  ...
  hTrackVx_PU            = new TH1D("hTrackVx_PU",           "Track v_{x}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hTrackVy_PU            = new TH1D("hTrackVy_PU",           "Track v_{y}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hTrackVz_PU            = new TH1D("hTrackVz_PU",           "Track v_{z}",                                   nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  ...
  // with-pileup primary histograms
  hPrimaryNMms_PU        = new TH1D("hPrimaryNMms_PU",        "Primary N_{layer}^{MMS}",                      nNHitBins, rNHitBins[0], rNHitBins[1]);
  hPrimaryNMap_PU        = new TH1D("hPrimaryNMap_PU",        "Primary N_{layer}^{MAPS}",                     nNHitBins, rNHitBins[0], rNHitBins[1]);
  hPrimaryNInt_PU        = new TH1D("hPrimaryNInt_PU",        "Primary N_{layer}^{INTT}",                     nNHitBins, rNHitBins[0], rNHitBins[1]);
  hPrimaryNTpc_PU        = new TH1D("hPrimaryNTpc_PU",        "Primary N_{layer}^{TPC}",                      nNHitBins, rNHitBins[0], rNHitBins[1]);
  hPrimaryNTot_PU        = new TH1D("hPrimaryNTot_PU",        "Primary N_{layer}^{tot}",                      nNHitBins, rNHitBins[0], rNHitBins[1]);
  hPrimaryPerMms_PU      = new TH1D("hPrimaryPerMms_PU",      "Primary r_{MMS}",                              nPerBins,  rPerBins[0],  rPerBins[1]);
  hPrimaryPerMap_PU      = new TH1D("hPrimaryPerMap_PU",      "Primary r_{MAPS}",                             nPerBins,  rPerBins[0],  rPerBins[1]);
  hPrimaryPerInt_PU      = new TH1D("hPrimaryPerInt_PU",      "Primary r_{INTT}",                             nPerBins,  rPerBins[0],  rPerBins[1]);
  hPrimaryPerTpc_PU      = new TH1D("hPrimaryPerTpc_PU",      "Primary r_{TPC}",                              nPerBins,  rPerBins[0],  rPerBins[1]);
  hPrimaryPerTot_PU      = new TH1D("hPrimaryPerTot_PU",      "Primary r_{tot}",                              nPerBins,  rPerBins[0],  rPerBins[1]);
  hPrimaryChi2_PU        = new TH1D("hPrimaryChi2_PU",        "Primary #chi^{2}",                             nChiBins,  rChiBins[0],  rChiBins[1]);
  hPrimaryNDF_PU         = new TH1D("hPrimaryNDF_PU",         "Primary ndf",                                  nNHitBins, rNHitBins[0], rNHitBins[1]);
  hPrimaryQuality_PU     = new TH1D("hPrimaryQuality_PU",     "Primary #chi^{2}/ndf",                         nQualBins, rQualBins[0], rQualBins[1]);
  hPrimaryDCAxy_PU       = new TH1D("hPrimaryDCAxy_PU",       "Primary DCA_{xy}",                             nDcaBins,  rDcaBins[0],  rDcaBins[1]);
  hPrimaryDCAz_PU        = new TH1D("hPrimaryDCAz_PU",        "Primary DCA_{z}",                              nDcaBins,  rDcaBins[0],  rDcaBins[1]);
  hPrimaryVx_PU          = new TH1D("hPrimaryVx_PU",          "Primary v_{x}",                                nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hPrimaryVy_PU          = new TH1D("hPrimaryVy_PU",          "Primary v_{y}",                                nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hPrimaryVz_PU          = new TH1D("hPrimaryVz_PU",          "Primary v_{z}",                                nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hPrimaryEta_PU         = new TH1D("hPrimaryEta_PU",         "Primary #eta",                                 nEtaBins,  rEtaBins[0],  rEtaBins[1]);
  hPrimaryPhi_PU         = new TH1D("hPrimaryPhi_PU",         "Primary #phi",                                 nPhiBins,  rPhiBins[0],  rPhiBins[1]);
  hPrimaryPt_PU          = new TH1D("hPrimaryPt_PU",          "Primary p_{T}",                                nPtBins,   rPtBins[0],   rPtBins[1]);
  hDeltaPrimDCAxy_PU     = new TH1D("hDeltaPrimDCAxy_PU",     "DCA_{xy} \%-error",                            nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaPrimDCAz_PU      = new TH1D("hDeltaPrimDCAz_PU",      "DCA_{z} \%-error",                             nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaPrimEta_PU       = new TH1D("hDeltaPrimEta_PU",       "#eta \%-error",                                nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaPrimPhi_PU       = new TH1D("hDeltaPrimPhi_PU",       "#phi \%-error",                                nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaPrimPt_PU        = new TH1D("hDeltaPrimPt_PU",        "p_{T} \%-error",                               nErrBins,  rErrBins[0],  rErrBins[1]);
  hPrimaryPtVsNMms_PU    = new TH2D("hPrimaryPtVsNMms_PU",    "Primary p_{T} vs. N_{layer}^{MMS}",            nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsNMap_PU    = new TH2D("hPrimaryPtVsNMap_PU",    "Primary p_{T} vs. N_{layer}^{MAPS}",           nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsNInt_PU    = new TH2D("hPrimaryPtVsNInt_PU",    "Primary p_{T} vs. N_{layer}^{INTT}",           nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsNTpc_PU    = new TH2D("hPrimaryPtVsNTpc_PU",    "Primary p_{T} vs. N_{layer}^{TPC}",            nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsNTot_PU    = new TH2D("hPrimaryPtVsNTot_PU",    "Primary p_{T} vs. N_{layer}^{tot}",            nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsPerMms_PU  = new TH2D("hPrimaryPtVsPerMms_PU",  "Primary p_{T} vs. r_{MMS}",                    nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsPerMap_PU  = new TH2D("hPrimaryPtVsPerMap_PU",  "Primary p_{T} vs. r_{MAPS}",                   nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsPerInt_PU  = new TH2D("hPrimaryPtVsPerInt_PU",  "Primary p_{T} vs. r_{INTT}",                   nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsPerTpc_PU  = new TH2D("hPrimaryPtVsPerTpc_PU",  "Primary p_{T} vs. r_{TPC}",                    nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsPerTot_PU  = new TH2D("hPrimaryPtVsPerTot_PU",  "Primary p_{T} vs. r_{tot}",                    nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsChi2_PU    = new TH2D("hPrimaryPtVsChi2_PU",    "Primary p_{T} vs. #chi^{2}",                   nChiBins,  rChiBins[0],  rChiBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsNDF_PU     = new TH2D("hPrimaryPtVsNDF_PU",     "Primary p_{T} vs. ndf",                        nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsQuality_PU = new TH2D("hPrimaryPtVsQuality_PU", "Primary p_{T} vs. #chi^{2}/ndf",               nQualBins, rQualBins[0], rQualBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsDCAxy_PU   = new TH2D("hPrimaryPtVsDCAxy_PU",   "Primary p_{T} vs. DCA_{xy}",                   nDcaBins,  rDcaBins[0],  rDcaBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hPrimaryPtVsDCAz_PU    = new TH2D("hPrimaryPtVsDCAz_PU",    "Primary p_{T} vs. DCA_{z}",                    nDcaBins,  rDcaBins[0],  rDcaBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hDeltaDCAxyVsPrimPt_PU = new TH2D("hDeltaDCAxyVsPrimPt_PU", "DCA_{xy} \%-error vs. primary p_{T}",          nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaDCAzVsPrimPt_PU  = new TH2D("hDeltaDCAzVsPrimPt_PU",  "DCA_{z} \%-error vs. primary p_{T}",           nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaEtaVsPrimPt_PU   = new TH2D("hDeltaEtaVsPrimPt_PU",   "#eta^{prim} \%-error vs. primary p_{T}",       nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaPhiVsPrimPt_PU   = new TH2D("hDeltaPhiVsPrimPt_PU",   "#phi^{prim} \%-error vs. primary p_{T}",       nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaPtVsPrimPt_PU    = new TH2D("hDeltaPtVsPrimPt_PU",    "p_{T}^{prim} \%-error vs. primary p_{T}",      nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  // with-pileup primary histograms
  hNonPrimNMms_PU        = new TH1D("hNonPrimNMms_PU",        "Non-Prim. N_{layer}^{MMS}",                     nNHitBins, rNHitBins[0], rNHitBins[1]);
  hNonPrimNMap_PU        = new TH1D("hNonPrimNMap_PU",        "Non-Prim. N_{layer}^{MAPS}",                    nNHitBins, rNHitBins[0], rNHitBins[1]);
  hNonPrimNInt_PU        = new TH1D("hNonPrimNInt_PU",        "Non-Prim. N_{layer}^{INTT}",                    nNHitBins, rNHitBins[0], rNHitBins[1]);
  hNonPrimNTpc_PU        = new TH1D("hNonPrimNTpc_PU",        "Non-Prim. N_{layer}^{TPC}",                     nNHitBins, rNHitBins[0], rNHitBins[1]);
  hNonPrimNTot_PU        = new TH1D("hNonPrimNTot_PU",        "Non-Prim. N_{layer}^{tot}",                     nNHitBins, rNHitBins[0], rNHitBins[1]);
  hNonPrimPerMms_PU      = new TH1D("hNonPrimPerMms_PU",      "Non-Prim. r_{MMS}",                             nPerBins,  rPerBins[0],  rPerBins[1]);
  hNonPrimPerMap_PU      = new TH1D("hNonPrimPerMap_PU",      "Non-Prim. r_{MAPS}",                            nPerBins,  rPerBins[0],  rPerBins[1]);
  hNonPrimPerInt_PU      = new TH1D("hNonPrimPerInt_PU",      "Non-Prim. r_{INTT}",                            nPerBins,  rPerBins[0],  rPerBins[1]);
  hNonPrimPerTpc_PU      = new TH1D("hNonPrimPerTpc_PU",      "Non-Prim. r_{TPC}",                             nPerBins,  rPerBins[0],  rPerBins[1]);
  hNonPrimPerTot_PU      = new TH1D("hNonPrimPerTot_PU",      "Non-Prim. r_{tot}",                             nPerBins,  rPerBins[0],  rPerBins[1]);
  hNonPrimChi2_PU        = new TH1D("hNonPrimChi2_PU",        "Non-Prim. #chi^{2}",                            nChiBins,  rChiBins[0],  rChiBins[1]);
  hNonPrimNDF_PU         = new TH1D("hNonPrimNDF_PU",         "Non-Prim. ndf",                                 nNHitBins, rNHitBins[0], rNHitBins[1]);
  hNonPrimQuality_PU     = new TH1D("hNonPrimQuality_PU",     "Non-Prim. #chi^{2}/ndf",                        nQualBins, rQualBins[0], rQualBins[1]);
  hNonPrimDCAxy_PU       = new TH1D("hNonPrimDCAxy_PU",       "Non-Prim. DCA_{xy}",                            nDcaBins,  rDcaBins[0],  rDcaBins[1]);
  hNonPrimDCAz_PU        = new TH1D("hNonPrimDCAz_PU",        "Non-Prim. DCA_{z}",                             nDcaBins,  rDcaBins[0],  rDcaBins[1]);
  hNonPrimVx_PU          = new TH1D("hNonPrimVx_PU",          "Non-Prim. v_{x}",                               nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hNonPrimVy_PU          = new TH1D("hNonPrimVy_PU",          "Non-Prim. v_{y}",                               nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hNonPrimVz_PU          = new TH1D("hNonPrimVz_PU",          "Non-Prim. v_{z}",                               nVtxBins,  rVtxBins[0],  rVtxBins[1]);
  hNonPrimEta_PU         = new TH1D("hNonPrimEta_PU",         "Non-Prim. #eta",                                nEtaBins,  rEtaBins[0],  rEtaBins[1]);
  hNonPrimPhi_PU         = new TH1D("hNonPrimPhi_PU",         "Non-Prim. #phi",                                nPhiBins,  rPhiBins[0],  rPhiBins[1]);
  hNonPrimPt_PU          = new TH1D("hNonPrimPt_PU",          "Non-Prim. p_{T}",                               nPtBins,   rPtBins[0],   rPtBins[1]);
  hDeltaNoPrDCAxy_PU     = new TH1D("hDeltaNoPrDCAxy_PU",     "DCA_{xy} \%-error",                             nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaNoPrDCAz_PU      = new TH1D("hDeltaNoPrDCAz_PU",      "DCA_{z} \%-error",                              nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaNoPrEta_PU       = new TH1D("hDeltaNoPrEta_PU",       "#eta \%-error",                                 nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaNoPrPhi_PU       = new TH1D("hDeltaNoPrPhi_PU",       "#phi \%-error",                                 nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaNoPrPt_PU        = new TH1D("hDeltaNoPrPt_PU",        "p_{T} \%-error",                                nErrBins,  rErrBins[0],  rErrBins[1]);
  hNonPrimPtVsNMms_PU    = new TH2D("hNonPrimPtVsNMms_PU",    "Non-Prim. p_{T} vs. N_{layer}^{MMS}",           nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsNMap_PU    = new TH2D("hNonPrimPtVsNMap_PU",    "Non-Prim. p_{T} vs. N_{layer}^{MAPS}",          nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsNInt_PU    = new TH2D("hNonPrimPtVsNInt_PU",    "Non-Prim. p_{T} vs. N_{layer}^{INTT}",          nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsNTpc_PU    = new TH2D("hNonPrimPtVsNTpc_PU",    "Non-Prim. p_{T} vs. N_{layer}^{TPC}",           nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsNTot_PU    = new TH2D("hNonPrimPtVsNTot_PU",    "Non-Prim. p_{T} vs. N_{layer}^{tot}",           nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsPerMms_PU  = new TH2D("hNonPrimPtVsPerMms_PU",  "Non-Prim. p_{T} vs. r_{MMS}",                   nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsPerMap_PU  = new TH2D("hNonPrimPtVsPerMap_PU",  "Non-Prim. p_{T} vs. r_{MAPS}",                  nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsPerInt_PU  = new TH2D("hNonPrimPtVsPerInt_PU",  "Non-Prim. p_{T} vs. r_{INTT}",                  nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsPerTpc_PU  = new TH2D("hNonPrimPtVsPerTpc_PU",  "Non-Prim. p_{T} vs. r_{TPC}",                   nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsPerTot_PU  = new TH2D("hNonPrimPtVsPerTot_PU",  "Non-Prim. p_{T} vs. r_{tot}",                   nPerBins,  rPerBins[0],  rPerBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsChi2_PU    = new TH2D("hNonPrimPtVsChi2_PU",    "Non-Prim. p_{T} vs. #chi^{2}",                  nChiBins,  rChiBins[0],  rChiBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsNDF_PU     = new TH2D("hNonPrimPtVsNDF_PU",     "Non-Prim. p_{T} vs. ndf",                       nNHitBins, rNHitBins[0], rNHitBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsQuality_PU = new TH2D("hNonPrimPtVsQuality_PU", "Non-Prim. p_{T} vs. #chi^{2}/ndf",              nQualBins, rQualBins[0], rQualBins[1], nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsDCAxy_PU   = new TH2D("hNonPrimPtVsDCAxy_PU",   "Non-Prim. p_{T} vs. DCA_{xy}",                  nDcaBins,  rDcaBins[0],  rDcaBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hNonPrimPtVsDCAz_PU    = new TH2D("hNonPrimPtVsDCAz_PU",    "Non-Prim. p_{T} vs. DCA_{z}",                   nDcaBins,  rDcaBins[0],  rDcaBins[1],  nPtBins,   rPtBins[0],   rPtBins[1]);
  hDeltaDCAxyVsNoPrPt_PU = new TH2D("hDeltaDCAxyVsNoPrPt_PU", "DCA_{xy} \%-error vs. non-prim. p_{T}",         nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaDCAzVsNoPrPt_PU  = new TH2D("hDeltaDCAzVsNoPrPt_PU",  "DCA_{z} \%-error vs. non-prim. p_{T}",          nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaEtaVsNoPrPt_PU   = new TH2D("hDeltaEtaVsNoPrPt_PU",   "#eta^{non-prim} \%-error vs. non-prim. p_{T}",  nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaPhiVsNoPrPt_PU   = new TH2D("hDeltaPhiVsNoPrPt_PU",   "#phi^{non-prim} \%-error vs. non-prim. p_{T}",  nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  hDeltaPtVsNoPrPt_PU    = new TH2D("hDeltaPtVsNoPrPt_PU",    "p_{T}^{non-prim} \%-error vs. non-prim. p_{T}", nPtBins,   rPtBins[0],   rPtBins[1],   nErrBins,  rErrBins[0],  rErrBins[1]);
  // embed-only errors
  hTrackNMms             -> Sumw2();
  hTrackNMap             -> Sumw2();
  hTrackNInt             -> Sumw2();
...
void STrackCutStudy::CreatePlots(){
  ...
  // text parameters
  const TString sLeg[NTyp]   = {"Tracks", "Truth", "Weird Tracks", "Pileup", "Pileup #bf{[gprimary == 1]}", "Pileup #bf{[gprimary != 1]}"};
  ...
  pil -> AddEntry(hTrackPt_PU,   sLeg[3].Data(), "pf");
  pil -> AddEntry(hPrimaryPt_PU, sLeg[4].Data(), "pf");
  pil -> AddEntry(hNonPrimPt_PU, sLeg[5].Data(), "pf");
...
void STrackCutStudy::SaveHists() {
  ...
  const TString sOutDir[NTyp] = {"Track", "Truth", "Weird", "Pileup", "Primary", "NonPrimary"};
