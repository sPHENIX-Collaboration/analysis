...
void display_hot(const string &input, const string &hotList, const string &output="plots.pdf") {
    cout << "#############################" << endl;
...
if(argc < 3 || argc > 4){
        cout << "usage: ./plots-hot input hotList [output]" << endl;
    ...
    display_hot(argv[1], argv[2], output);
