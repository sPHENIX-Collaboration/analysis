...
void plotQA_Resolution()
{
  ...
  TGraphAsymmErrors *g_resolution_2018_pion_hcalout = (TGraphAsymmErrors*)File_2018_ohcal->Get("g_resolution_2018_pion_hcalout");
  ...
  TGraphAsymmErrors *g_resolution_2018_electron = (TGraphAsymmErrors*)File_2018_electron->Get("g_resolution_2018_electron");
  ...
  TGraphAsymmErrors *g_resolution_2018_pion = (TGraphAsymmErrors*)File_2018_pion->Get("g_resolution_2018_pion");
  ...
  g_resolution_2018_pion->SetMarkerStyle(20);
  g_resolution_2018_pion->SetMarkerColor(kGray+2);
  g_resolution_2018_pion->SetMarkerSize(2.0);
  g_resolution_2018_pion->Draw("pE same");

  g_resolution_2018_pion_hcalout->SetMarkerStyle(34);
  g_resolution_2018_pion_hcalout->SetMarkerColor(6);
  g_resolution_2018_pion_hcalout->SetMarkerSize(2.0);
  g_resolution_2018_pion_hcalout->Draw("pE same");

  g_resolution_2018_electron->SetMarkerStyle(20);
  g_resolution_2018_electron->SetMarkerColor(4);
  g_resolution_2018_electron->SetMarkerSize(2.0);
  g_resolution_2018_electron->Draw("pE same");

  TLegend *leg_linear = new TLegend(0.5,0.6,0.8,0.8);
  leg_linear->SetBorderSize(0);
  leg_linear->SetFillColor(0);
  leg_linear->AddEntry(g_resolution_2017_pion,"#pi- T1044-2017","p");
  leg_linear->AddEntry(g_resolution_2018_pion,"#pi- T1044-2018","p");
  leg_linear->AddEntry(g_resolution_2018_pion_hcalout,"#pi- T1044-2018 & OHCal","p");
  leg_linear->AddEntry(g_resolution_2018_electron,"e- T1044-2018","p");
  leg_linear->AddEntry(l_unity,"unity","l");
  leg_linear->Draw("same");

  c_Resolution->SaveAs("../figures/HCAL_ShowerCalib/c_Resolution.eps");
}
