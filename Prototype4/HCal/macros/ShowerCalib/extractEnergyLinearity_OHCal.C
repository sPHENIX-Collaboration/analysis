...
void extractEnergyLinearity_OHCal()
{
  ...
  TH1F *h_mEnergy_pion_5GeV = (TH1F*)File_5GeV->Get("h_mEnergyOut_pion_ShowerCalib");
  ...
  TH1F *h_mEnergy_pion_8GeV = (TH1F*)File_8GeV->Get("h_mEnergyOut_pion_ShowerCalib");
  ...
  TH1F *h_mEnergy_pion_12GeV = (TH1F*)File_12GeV->Get("h_mEnergyOut_pion_ShowerCalib");
  ...
  c_Energy->cd(1);
  h_mEnergy_pion_5GeV->SetTitle("5 GeV");
  h_mEnergy_pion_5GeV->GetXaxis()->SetTitle("Shower Calibrated Energy (GeV)");
  ...
  c_Energy->cd(2);
  h_mEnergy_pion_8GeV->SetTitle("8 GeV");
  h_mEnergy_pion_8GeV->GetXaxis()->SetTitle("Shower Calibrated Energy (GeV)");
  ...
  c_Energy->cd(3);
  h_mEnergy_pion_12GeV->SetTitle("12 GeV");
  h_mEnergy_pion_12GeV->GetXaxis()->SetTitle("Shower Calibrated Energy (GeV)");
  ...
  c_Energy->SaveAs("../figures/HCAL_ShowerCalib/c_Energy_ShowerCalib_OHCAL.eps");
  ...
  h_play->GetYaxis()->SetTitle("Shower Calibrated Energy (GeV)");
  ...
  */
  ...
  c_Linearity->SaveAs("../figures/HCAL_ShowerCalib/c_Linearity_ShowerCalib_OHCAL.eps");
  ...
  c_Resolution->SaveAs("../figures/HCAL_ShowerCalib/c_Resolution_ShowerCalib_OHCAL.eps");
  //------------------------resolution-----------------------

  string outputfile;
  outputfile = "/sphenix/user/xusun/TestBeam/ShowerCalibAna/T1044_2018_pion_hcalout.root";
  TFile *File_OutPut = new TFile(outputfile.c_str(),"RECREATE");
  File_OutPut->cd();
  g_linearity->SetName("g_linearity_2018_pion_hcalout");
  g_linearity->Write();
  g_resolution->SetName("g_resolution_2018_pion_hcalout");
  g_resolution->Write();
  File_OutPut->Close();
}
