...
Proto4ShowerCalib::Proto4ShowerCalib(const std::string &filename) :
    SubsysReco("Proto4ShowerCalib"), _is_sim(false), _filename(filename), _ievent(
        0)
{
...
int
Proto4ShowerCalib::InitRun(PHCompositeNode *topNode)
{
  if (verbosity)
...
int
Proto4ShowerCalib::End(PHCompositeNode *topNode)
{
...
int
Proto4ShowerCalib::Init(PHCompositeNode *topNode)
{
...
int
Proto4ShowerCalib::process_event(PHCompositeNode *topNode)
{
...
int
Proto4ShowerCalib::LoadRecalibMap(const std::string & file)
{
  if (verbosity)
    {
