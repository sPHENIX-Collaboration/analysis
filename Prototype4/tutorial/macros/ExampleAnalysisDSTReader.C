...
)
{
  ...
  TFile * file =
      TFile::Open(
          "/sphenix/data/data03/phnxreco/sphenix/t1044/production/production_0306/beam_00000668-0000_DSTReader.root");
  ...
  T->SetAlias("C2_Sum_e",
      "TOWER_CALIB_C2[0].energy + TOWER_CALIB_C2[1].energy");
  ...
  T->SetAlias("Hodoscope_h3_v4",
      "abs(Average_HODO_HORIZONTAL-3)<.5 && abs(Average_HODO_VERTICAL-4)<.5");
  ...
  T->SetAlias("CherenkovCut", "C2_Sum_e>1000");
  ...
  T->Draw("C2_Sum_e>>hC2_Sum_e(1000,-1000,17000)",
      "Valid_Hodoscope_Clean_VETO_Counter", "");
  T->Draw("C2_Sum_e>>hC2_Sum_e_c(1000,-1000,17000)",
...
//  hC2_Sum_e_c->SetLineColor(kGreen + 2);
  ...
  T->Draw("Energy_Sum_CEMC>>hEnergy_Sum_CEMC(400,0,40)",
      "Valid_Hodoscope_Clean_VETO_Counter", "");
  T->Draw("Energy_Sum_CEMC>>hEnergy_Sum_CEMC_C(400,0,40)",
      "Valid_Hodoscope_Clean_VETO_Counter && CherenkovCut", "same");
...
//  hEnergy_Sum_CEMC_C->SetLineColor(kGreen + 2);
  ...
  T->Draw(
      "Energy_Sum_CEMC + Energy_Sum_HCALIN + Energy_Sum_HCALOUT>>hEnergy_Sum(400,0,40)",
      "Valid_Hodoscope_Clean_VETO_Counter", "");
  ...
  TH1 * hEnergy_Sum_CEMC_v2h3 = new TH1F("hEnergy_Sum_CEMC_v2h3",
      ";EMCal Calibrated Energy Sum (GeV);Count / bin", 100, 0, 40);

  T->Draw("Energy_Sum_CEMC>>hEnergy_Sum_CEMC_v2h3",
      "Valid_Hodoscope_Clean_VETO_Counter && CherenkovCut && Hodoscope_h3_v4",
      "");
