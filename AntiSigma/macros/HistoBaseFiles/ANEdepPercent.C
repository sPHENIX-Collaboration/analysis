void EdepPercentE()//(const char * particle = "e-", const int pz = 4, const int thickness = 18)
{
  ...
  //	  for (int k=0; k<3; k++)
  //	    {
	      sprintf(infile, "an1out.root");
	      char hname [100];
	      sprintf(hname, "Ean1d");
	      TH1F *h1 = new TH1F(hname, "Ean1d", 100, 0, 1);
	      ...
	      f->Close();
	      h1->Draw();
	      TFile *fout = TFile::Open("anpercent.root","UPDATE");
	      h1->Write();
	      fout->Write();
	      ...
	      sprintf(infile, "an2out.root");
	      char hname [100];
	      sprintf(hname, "Ean2d");
	      TH1F *h1 = new TH1F(hname, "Ean2d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(EA+ES)/(EA+ES+HOA+HOS+HIA+HIS+BH+MAG)");
	      ...
	      sprintf(infile, "an4out.root");
	      char hname [100];
	      sprintf(hname, "Ean4d");
	      TH1F *h1 = new TH1F(hname, "Ean4d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(EA+ES)/(EA+ES+HOA+HOS+HIA+HIS+BH+MAG");
	      ...
	      sprintf(infile, "an8out.root");
	      char hname [100];
	      sprintf(hname, "Ean8d");
	      TH1F *h1 = new TH1F(hname, "Ean8d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(EA+ES)/(EA+ES+HOA+HOS+HIA+HIS+BH+MAG)");
	      ...
	      sprintf(infile, "an12out.root");
	      char hname [100];
	      sprintf(hname, "Ean12d");
	      TH1F *h1 = new TH1F(hname, "Ean12d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(EA+ES)/(EA+ES+HOA+HOS+HIA+HIS+BH+MAG)");
	      ...
	      sprintf(infile, "an16out.root");
	      char hname [100];
	      sprintf(hname, "Ean16d");
	      TH1F *h1 = new TH1F(hname, "Ean16d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(EA+ES)/(EA+ES+HOA+HOS+HIA+HIS+BH+MAG)");
	      ...
	      sprintf(infile, "an32out.root");
	      char hname [100];
	      sprintf(hname, "Ean32d");
	      TH1F *h1 = new TH1F(hname, "Ean32d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(EA+ES)/(EA+ES+HOA+HOS+HIA+HIS+BH+MAG)");
	      ...
	      sprintf(infile, "an40out.root");
	      char hname [100];
	      sprintf(hname, "Ean40d");
	      TH1F *h1 = new TH1F(hname, "Ean40d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(EA+ES)/(EA+ES+HOA+HOS+HIA+HIS+BH+MAG)");
	      ...
	      sprintf(infile, "an0out.root");
	      char hname [100];
	      sprintf(hname, "an50d");
	      TH1F *h1 = new TH1F(hname, "an50d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(EA+ES)/(EA+ES+HOA+HOS+HIA+HIS+BH+MAG)");
...
{  
  TFile *fin = TFile::Open("anpercent.root");
  gROOT->cd();
...
void EdepPercentIH()//(const char * particle = "e-", const int pz = 4, const int thickness = 18)
{
  ...
  //	    {
	      sprintf(infile, "an1out.root");
	      char hname [100];
	      sprintf(hname, "HIan1d");
	      TH1F *h1 = new TH1F(hname, "HIan1d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      ...
	      sprintf(infile, "an2out.root");
	      char hname [100];
	      sprintf(hname, "HIan2d");
	      TH1F *h1 = new TH1F(hname, "HIan2d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HIA+HIS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an4out.root");
	      char hname [100];
	      sprintf(hname, "HIan4d");
	      TH1F *h1 = new TH1F(hname, "HIan4d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HIA+HIS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an8out.root");
	      char hname [100];
	      sprintf(hname, "HIan8d");
	      TH1F *h1 = new TH1F(hname, "HIan8d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HIA+HIS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an12out.root");
	      char hname [100];
	      sprintf(hname, "HIan12d");
	      TH1F *h1 = new TH1F(hname, "HIan12d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HIA+HIS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an16out.root");
	      char hname [100];
	      sprintf(hname, "HIan16d");
	      TH1F *h1 = new TH1F(hname, "HIan16d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HIA+HIS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an32out.root");
	      char hname [100];
	      sprintf(hname, "HIan32d");
	      TH1F *h1 = new TH1F(hname, "HIan32d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HIA+HIS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an40out.root");
	      char hname [100];
	      sprintf(hname, "HIan40d");
	      TH1F *h1 = new TH1F(hname, "HIan40d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HIA+HIS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an50out.root");
	      char hname [100];
	      sprintf(hname, "HIan50d");
	      TH1F *h1 = new TH1F(hname, "HIan50d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HIA+HIS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
...
void EdepPercentOH()//(const char * particle = "e-", const int pz = 4, const int thickness = 18)
{
  ...
  //	    {
	      sprintf(infile, "an1out.root");
	      char hname [100];
	      sprintf(hname, "HOan1d");
	      TH1F *h1 = new TH1F(hname, "HOan1d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      ...
	      sprintf(infile, "an2out.root");
	      char hname [100];
	      sprintf(hname, "HOan2d");
	      TH1F *h1 = new TH1F(hname, "HOan2d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HOA+HOS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an4out.root");
	      char hname [100];
	      sprintf(hname, "HOan4d");
	      TH1F *h1 = new TH1F(hname, "HOan4d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HOA+HOS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an8out.root");
	      char hname [100];
	      sprintf(hname, "HOan8d");
	      TH1F *h1 = new TH1F(hname, "HOan8d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HOA+HOS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an12out.root");
	      char hname [100];
	      sprintf(hname, "HOan12d");
	      TH1F *h1 = new TH1F(hname, "HOan12d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HOA+HOS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an16out.root");
	      char hname [100];
	      sprintf(hname, "HOan16d");
	      TH1F *h1 = new TH1F(hname, "HOan16d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HOA+HOS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an32out.root");
	      char hname [100];
	      sprintf(hname, "HOan32d");
	      TH1F *h1 = new TH1F(hname, "HOan32d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HOA+HOS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an40out.root");
	      char hname [100];
	      sprintf(hname, "HOan40d");
	      TH1F *h1 = new TH1F(hname, "HOan40d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HOA+HOS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
	      ...
	      sprintf(infile, "an50out.root");
	      char hname [100];
	      sprintf(hname, "HOan50d");
	      TH1F *h1 = new TH1F(hname, "HOan50d", 100, 0, 1);
	      TFile *f = TFile::Open(infile);
	      gROOT->cd();
	      TNtuple *nt = (TNtuple *)f->Get("ed");
	      nt->Project(hname,"(HOA+HOS)/(EA+ES+HIA+HIS+HOA+HOS+BH+MAG)");
...
void EdepSmall(const char *calo="HOan")
{
