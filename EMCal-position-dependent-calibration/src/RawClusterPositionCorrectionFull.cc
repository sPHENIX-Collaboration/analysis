...
int RawClusterPositionCorrectionFull::InitRun(PHCompositeNode *topNode)
{
  ...
  bins_eta = _eclus_calib_params.get_int_param(paramname.str()) + 1; // TODO
  ...
  bins_phi = _eclus_calib_params.get_int_param(paramname.str()) + 1; // TODO
...
{
  param.set_int_param("number_of_bins_eta", 385);
  param.set_int_param("number_of_bins_phi", 65);
