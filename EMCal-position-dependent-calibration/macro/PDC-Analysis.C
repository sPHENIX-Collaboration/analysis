...
void myAnalysis::process_event(UInt_t events) {
    ...
    for (UInt_t i = 0; i < events; ++i) {
        ...
        // hResponseCalibVsPhotonEtaVsPhotonPt->Fill(gpt, geta, response_calib);
    }
...
void PDC_Analysis(const string &i_input,
...
int main(int argc, char* argv[]) {
    ...
    PDC_Analysis(argv[1], outputFile, ntp_cluster_entries);
