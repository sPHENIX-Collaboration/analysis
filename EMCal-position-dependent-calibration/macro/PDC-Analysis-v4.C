...
// output: /sphenix/user/anarde/output/validation-original-plots-0.3-25-GeV.root
// OR
// input: /sphenix/u/anarde/scratch/data/validation-residual-0.3-25-GeV
// output: /sphenix/user/anarde/output/validation-residual-plots-0.3-25-GeV.root
//
// -- c++ includes --
#include <iostream>
#include <strings.h>
...
void myAnalysis::process_event(UInt_t events) {
    ...
    auto hDummyECore  = new TH1F("hDummyECore","",bins_ge_response, low_ge_response, high_ge_response);
