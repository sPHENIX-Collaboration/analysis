...
void Fun4All_testEtIso_Hijing(
                     int nEvents = 1,
                     const char *filelist1 = "dst_calo_cluster_run62_10GeVpythia.list",
                     const char *filelist2 = "dst_truth_run62_10GeVpythia.list",
		     const string outname = "test.root")
{
  ...
  ClusterIso *makeClusterEt = new ClusterIso("isoCluster",0,3,1,1);
  ///???
