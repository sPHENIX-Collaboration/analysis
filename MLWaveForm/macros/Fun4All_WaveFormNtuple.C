...
#include <waveform/WaveFormNtuple.h>

R__LOAD_LIBRARY(libfun4all.so)
R__LOAD_LIBRARY(libWaveForm.so)

void Fun4All_WaveFormNtuple(const int nEvents = 3, const std::string &infile = "/sphenix/tg/tg01/commissioning/CaloCalibWG/sli/2024data/condor44060/condorout/OutDir7/DST_CALOR-00044060-0007.root")
{
  ///////////////////////////////////////////
  // Make the Server
  //////////////////////////////////////////
  ...
  WaveFormNtuple *myreco = new WaveFormNtuple();
