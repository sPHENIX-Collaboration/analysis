...
void data20869_xy_mother(int core_i)
{
    ...
    string out_folder_directory = input_directory + "/condor_runXY_folder/" + "runXY_" + out_folder_index;
    ...
    int clu_sum_adc_cut = 31; // note : used 
    ...
    if (fabs(start_evt - INTTClu -> GetNEvt()) < 10000) { return; }
