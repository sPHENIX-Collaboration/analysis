...
int merged_tracklet_ana()
{
    ...
    string input_directory2 = ana_map_version::MC_input_directory + "/evt_tracklet_inner_phi_rotate/complete_file/" + ana_map_version::MC_tracklet_merged_folder;
    string input_file2 = "merged_hist_half_corr.root";
