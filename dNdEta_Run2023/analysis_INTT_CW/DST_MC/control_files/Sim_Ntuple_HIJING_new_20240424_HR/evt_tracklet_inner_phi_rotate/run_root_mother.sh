...
root -l -b -q /sphenix/user/ChengWei/INTT/INTT_dNdeta_repo/DST_MC/control_files/Sim_Ntuple_HIJING_new_20240424_HR/evt_tracklet_inner_phi_rotate/evtTracklet_mother.C\(${core_i}\)
