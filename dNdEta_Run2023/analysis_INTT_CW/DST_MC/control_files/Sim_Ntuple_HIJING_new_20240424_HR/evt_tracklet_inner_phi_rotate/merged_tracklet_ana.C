...
int merged_tracklet_ana()
{
    ...
    string input_directory2 = "/sphenix/user/ChengWei/sPH_dNdeta/Sim_Ntuple_HIJING_new_20240424_HR/evt_tracklet_inner_phi_rotate/complete_file/merged_file_folder";
    string input_file2 = "merged_hist_half_inner_phi_rotate_corr.root";
    string out_folder_directory2 = input_directory2 + "/eta_closer_out_test_MultiZBin_inner_phi_rotate_half_corr";
