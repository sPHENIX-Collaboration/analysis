...
int merged_tracklet_ana()
{
   string run_type_data = "data";
    ...
    string input_directory1 = "/sphenix/user/ChengWei/INTT/INTT_commissioning/ZeroField/F4A_20869/2024_05_07/folder_Data_CombinedNtuple_Run20869_HotDead_BCO_ADC_Survey/evt_tracklet/complete_file/merged_file_folder";
    string input_file1 = "merged_file.root";
    string out_folder_directory1 = input_directory1 + "/eta_closer_out_test_MultiZBin";
    bool Mbin_Z_evt_map_name_bool1 = 0;

    string input_directory2 = "/sphenix/user/ChengWei/INTT/INTT_commissioning/ZeroField/F4A_20869/2024_05_07/folder_Data_CombinedNtuple_Run20869_HotDead_BCO_ADC_Survey/evt_tracklet_inner_phi_rotate/complete_file/merged_file_folder";
    string input_file2 = "merged_file.root";
