...
void test_xy_388_000_geo_origin()
{
    ...
    INTTReadTree * INTTClu = new INTTReadTree(data_type, input_directory, MC_list_name, tree_name, clu_size_cut, clu_sum_adc_cut, 65535, N_ladder, offset_range, included_ladder_vec, 3, ladder_offset_vec);
    ...
    for (int event_i = 0; event_i < 5000; event_i ++)
    {
