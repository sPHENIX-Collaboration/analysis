...
// Tue Dec 26 05:12:53 2023 by ROOT version 6.26/06
// from TTree tree_geo_scan/tree_geo_scan
// found on file: geo_scan_1719900.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Double_t        angle_diff_fitYpos;
   Double_t        angle_diff_fitE;
   Int_t           random_seed;
   ...
   TBranch        *b_angle_diff_fitYpos;   //!
   TBranch        *b_angle_diff_fitE;   //!
   TBranch        *b_random_seed;   //!

   GeoScan(TChain *chain_in = 0, string folder_direction = "", string MC_list_name = "", int Nfile = -1);
   virtual ~GeoScan();
...
#ifdef GeoScan_cxx
GeoScan::GeoScan(TChain *chain_in, string folder_direction, string MC_list_name, int Nfile) : 
fChain(0),
...
Int_t GeoScan::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GeoScan::LoadTree(Long64_t entry)
{
...
void GeoScan::Init(TChain *chain_in)
{
   ...
   fChain->SetBranchAddress("angle_diff_fitYpos", &angle_diff_fitYpos, &b_angle_diff_fitYpos);
   fChain->SetBranchAddress("angle_diff_fitE", &angle_diff_fitE, &b_angle_diff_fitE);
   fChain->SetBranchAddress("random_seed", &random_seed, &b_random_seed);
   Notify();
}

Bool_t GeoScan::Notify()
{
...
void GeoScan::Show(Long64_t entry)
{
...
Int_t GeoScan::Cut(Long64_t entry)
{
