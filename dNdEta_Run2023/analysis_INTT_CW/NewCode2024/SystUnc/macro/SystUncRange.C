...
float SystUncRange()
{
    ...
    chain -> SetBranchAddress("UncRange_StatUnc", &UncRange_StatUnc);
    chain -> SetBranchAddress("UncRange_RunSegment", &UncRange_RunSegment);
    chain -> SetBranchAddress("UncRange_ClusAdc", &UncRange_ClusAdc);
    chain -> SetBranchAddress("UncRange_GeoOffset", &UncRange_GeoOffset);
    chain -> SetBranchAddress("UncRange_DeltaPhi", &UncRange_DeltaPhi);
    chain -> SetBranchAddress("UncRange_ClusPhiSize", &UncRange_ClusPhiSize);
    chain -> SetBranchAddress("UncRange_Final", &UncRange_Final);
