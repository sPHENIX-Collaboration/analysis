...
// Sun Mar  3 01:33:59 2024 by ROOT version 6.26/06
...
#ifndef MBDReaderV2_h
#define MBDReaderV2_h
...
#ifdef MBDReaderV2_cxx
MBDReaderV2::MBDReaderV2(TTree *tree) : fChain(0) 
{
...
MBDReaderV2::~MBDReaderV2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MBDReaderV2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MBDReaderV2::LoadTree(Long64_t entry)
{
...
void MBDReaderV2::Init(TTree *tree)
{
...
void MBDReaderV2::Show(Long64_t entry)
{
...
Int_t MBDReaderV2::Cut(Long64_t entry)
{
