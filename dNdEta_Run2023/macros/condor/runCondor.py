...
if __name__ == '__main__':
    ...
    condorFile.write("Executable         = production_INTT.sh\n")
    ...
    condorFile.write("Output             = ./condor_INTT/condorLog/process{}_$(Process).out\n".format('Data' if data else 'Sim{}'.format(generator)))
    condorFile.write("Error              = ./condor_INTT/condorLog/process{}_$(Process).err\n".format('Data' if data else 'Sim{}'.format(generator)))
    condorFile.write("Log                = ./condor_INTT/condorLog/process{}_$(Process).log\n".format('Data' if data else 'Sim{}'.format(generator)))
