...
int main(int argc, char *argv[])
{
    ...
    TH1F *hM_INTTVtxZ_MBDAsym_le0p75 = new TH1F("hM_INTTVtxZ_MBDAsym_le0p75", "hM_INTTVtxZ_MBDAsym_le0p75", 160, -60, 20);
    ...
    for (int ev = 0; ev < t->GetEntriesFast(); ev++)
    {
        ...
        {
            hM_INTTVtxZ_MBDAsym_le0p75->Fill(PV_z);
            if (PV_z >= -30 && PV_z <= -10)
            {
    ...
    hM_INTTVtxZ_MBDAsym_le0p75->Write();
