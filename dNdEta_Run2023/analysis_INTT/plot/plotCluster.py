...
if __name__ == '__main__':
    ...
    Draw_1Dhist(hM_ClusZ_all, isdata, False, False, 1.3, 'Cluster Z pos [cm]', 'cm', '{}/ClusZ_all'.format(plotdir))
    Draw_1Dhist(hM_ClusZ_layer1, isdata, False, False, 1.3, 'Cluster Z pos [cm]', 'cm', '{}/ClusZ_layer1'.format(plotdir))
    Draw_1Dhist(hM_ClusZ_layer2, isdata, False, False, 1.3, 'Cluster Z pos [cm]', 'cm', '{}/ClusZ_layer2'.format(plotdir))
    ...
    Draw_2Dhist(hM_ClusX_ClusY_all, isdata, False, False, 0.15, 'Cluster X pos [cm]', 'Cluster Y pos [cm]', 'Entries', 'colz', '{}/ClusX_ClusY_all'.format(plotdir))
    Draw_2Dhist(hM_ClusX_ClusY_ClusPhiSize43or46, isdata, True, False, 0.15, 'Cluster X pos [cm]', 'Cluster Y pos [cm]', 'Entries', 'colz', '{}/ClusX_ClusY_ClusPhiSize43or46'.format(plotdir))
    Draw_2Dhist(hM_ClusX_ClusY_ClusPhiSize43, isdata, True, False, 0.15, 'Cluster X pos [cm]', 'Cluster Y pos [cm]', 'Entries', 'colz', '{}/ClusX_ClusY_ClusPhiSize43'.format(plotdir))
    Draw_2Dhist(hM_ClusX_ClusY_ClusPhiSize46, isdata, True, False, 0.15, 'Cluster X pos [cm]', 'Cluster Y pos [cm]', 'Entries', 'colz', '{}/ClusX_ClusY_ClusPhiSize46'.format(plotdir))
    Draw_2Dhist(hM_ClusX_ClusY_all_weiphisize, isdata, False, False, 0.15, 'Cluster X pos [cm]', 'Cluster Y pos [cm]','Entries', 'colz', '{}/ClusX_ClusY_all_weiphisize'.format(plotdir))
    ...
    Draw_2Dhist(hM_ClusX_ClusY_all_avgphisize, isdata, False, False, 0.15, 'Cluster X pos [cm]', 'Cluster Y pos [cm]','Average cluster #phi size', 'colz', '{}/ClusX_ClusY_all_avgphisize'.format(plotdir))
    Draw_2Dhist(hM_ClusX_ClusY_all_avgclusadc, isdata, False, False, 0.15, 'Cluster X pos [cm]', 'Cluster Y pos [cm]', 'Average cluster ADC', 'colz', '{}/ClusX_ClusY_all_avgclusadc'.format(plotdir))

    Draw_2Dhist(hM_ClusZ_ClusPhiPV_all, isdata, False, False, 0.16, 'Cluster Z pos [cm]', 'Cluster #phi (w.r.t PV)', 'Entries', 'colz', '{}/ClusZ_ClusPhiPV_all'.format(plotdir))
    Draw_2Dhist(hM_ClusZ_ClusPhiPV_layer1, isdata, False, False, 0.16, 'Cluster Z pos [cm]', 'Cluster #phi (w.r.t PV)', 'Entries', 'colz', '{}/ClusZ_ClusPhiPV_layer1'.format(plotdir))
    Draw_2Dhist(hM_ClusZ_ClusPhiPV_layer2, isdata, False, False, 0.16, 'Cluster Z pos [cm]', 'Cluster #phi (w.r.t PV)', 'Entries', 'colz', '{}/ClusZ_ClusPhiPV_layer2'.format(plotdir))
    Draw_2Dhist(hM_ClusZ_ClusPhiPV_all_coarse, isdata, False, False, 0.16, 'Cluster Z pos [cm]', 'Cluster #phi (w.r.t PV)', 'Entries', 'colz', '{}/ClusZ_ClusPhiPV_all_coarse'.format(plotdir))
    ...
    Draw_2Dhist(hM_ClusZ_ClusPhiPV_all_coarse_avgphisize, isdata, False, False, 0.16, 'Cluster Z pos [cm]', 'Cluster #phi (w.r.t PV)', 'Average cluster #phi size', 'colz', '{}/ClusZ_ClusPhiPV_all_coarse_avgphisize'.format(plotdir))
    Draw_2Dhist(hM_ClusZ_ClusPhiPV_all_coarse_avgclusadc, isdata, False, False, 0.16, 'Cluster Z pos [cm]', 'Cluster #phi (w.r.t PV)', 'Average cluster ADC', 'colz', '{}/ClusZ_ClusPhiPV_all_coarse_avgclusadc'.format(plotdir))
