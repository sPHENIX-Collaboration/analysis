...
if __name__ == '__main__':
    ...
    hM_dEta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_dEta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10')
    hM_dEta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_dEta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10')
    hM_dEta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_dEta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10')
    hM_dEta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_dEta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10')
    hM_dEta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_dEta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10')
    ...
    hM_Eta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_Eta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10')
    hM_Eta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_Eta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10')
    hM_Eta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_Eta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10')
    hM_Eta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_data = GetHistogram("{}/hists_merged.root".format(datahistdir), 'hM_Eta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10')
    ...
    l_hM_dEta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_sim = []
    l_hM_dEta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_sim = []
    l_hM_dEta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_sim = []
    l_hM_dEta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10_sim = []
    ...
    l_hM_Eta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_sim = []
    l_hM_Eta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_sim = []
    l_hM_Eta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_sim = []
    l_hM_Eta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_sim = []
    ...
    for i, simhistd in enumerate(simhistdir):
        ...
        l_hM_dEta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_dEta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10'))
        l_hM_dEta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_dEta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10'))
        l_hM_dEta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_dEta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10'))
        l_hM_dEta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_dEta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10'))
        l_hM_dEta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_dEta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10'))
        ...
        l_hM_Eta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_Eta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10'))
        l_hM_Eta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_Eta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10'))
        l_hM_Eta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_Eta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10'))
        l_hM_Eta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_sim.append(GetHistogram("{}/hists_merged.root".format(simhistd), 'hM_Eta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10'))
    ...
    Draw_1Dhist_datasimcomp(hM_NClusLayer1_data, l_hM_NClusLayer1_sim, padmargin, 'data', True, 100, 'Number of clusters (inner)', '', False, simlegtext, [str_clussel], './DataSimComp/{}/NClusLayer1'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_NClusLayer2_data, l_hM_NClusLayer2_sim, padmargin, 'data', True, 100, 'Number of clusters (outer)', '', False, simlegtext, [str_clussel], './DataSimComp/{}/NClusLayer2'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_NClusLayer1_zvtxwei_data, l_hM_NClusLayer1_zvtxwei_sim, padmargin, 'data', True, 100, 'Number of clusters (inner)', '', False, simlegtext, [str_clussel], './DataSimComp/{}/NClusLayer1_zvtxwei'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_NTklclusLayer1_data, l_hM_NTklclusLayer1_sim, padmargin, 'data', True, 100, 'Number of tracklet clusters (inner)', '', False, simlegtext, [str_clussel], './DataSimComp/{}/NTklClusLayer1'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_NRecotkl_Raw_data, l_hM_NRecotkl_Raw_sim, padmargin, 'data', True, 100, 'Number of reco-tracklets', '', False, simlegtext, [str_clussel], './DataSimComp/{}/NRecoTracklets_Raw'.format(plotdir))
    
    Draw_1Dhist_datasimcomp(hM_RecoPVz_data, l_hM_RecoPVz_sim, padmargin, 'data', False, 1.7, 'INTT Z_{vtx} [cm]', 'cm', False, simlegtext, ['-40#leqZ_{vtx}#leq0[cm]'], './DataSimComp/{}/RecoPVz'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_RecoPVz_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_RecoPVz_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 1.7, 'INTT Z_{vtx} [cm]', 'cm', False, simlegtext, ['-30#leqZ_{vtx}#leq-10[cm], |Asymm._{MBD}|#leq0.75'], './DataSimComp/{}/RecoPVz_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_MBDChargeAsymm_Le0p75_VtxZm30tom10_data, l_hM_MBDChargeAsymm_Le0p75_VtxZm30tom10_sim, padmargin, 'data', True, 15, 'MBD charge asymmetry', '', False, simlegtext, ['-30#leqZ_{vtx}#leq-10[cm], |Asymm._{MBD}|#leq0.75'], './DataSimComp/{}/MBDChargeAsymm_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_clusphi_data, l_hM_clusphi_sim, padmargin, 'data', False, 1.8, 'Cluster #phi', '', False, simlegtext, [str_clussel], './DataSimComp/{}/Cluster_Phi'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_clusphi_zvtxwei_data, l_hM_clusphi_zvtxwei_sim, padmargin, 'data', False, 1.8, 'Cluster #phi', '', False, simlegtext, [str_clussel], './DataSimComp/{}/Cluster_Phi_zvtxwei'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_cluseta_data, l_hM_cluseta_sim, padmargin, 'data', False, 1.8, 'Cluster #eta', '', False, simlegtext, [str_clussel], './DataSimComp/{}/Cluster_Eta'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_cluseta_zvtxwei_data, l_hM_cluseta_zvtxwei_sim, padmargin, 'data', False, 1.8, 'Cluster #eta', '', False, simlegtext, [str_clussel], './DataSimComp/{}/Cluster_Eta_zvtxwei'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_clusphisize_data, l_hM_clusphisize_sim, padmargin, 'data', True, 100, 'Cluster #phi size', '', False, simlegtext, [str_clussel], './DataSimComp/{}/Cluster_PhiSize'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_clusadc_data, l_hM_clusadc_sim, padmargin, 'data', True, 100, 'Cluster ADC', '', False, simlegtext, [str_clussel], './DataSimComp/{}/Cluster_ADC'.format(plotdir))

    Draw_1Dhist_datasimcomp(hM_dEta_reco_data, l_hM_dEta_reco_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, [str_clussel], './DataSimComp/{}/RecoTracklet_dEta'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_altrange_data, l_hM_dEta_reco_altrange_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, [str_clussel], './DataSimComp/{}/RecoTracklet_dEta_altrange'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_altrange_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_altrange_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 0-70%, |Asymm._{MBD}|#leq0.75', '-30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_altrange_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    # Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_0to5_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_0to5_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 0-5%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_0to5_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 5-10%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 10-20%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_20to30_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_20to30_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 20-30%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_20to30_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_30to40_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_30to40_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 30-40%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_30to40_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 40-50%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 50-60%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 60-70%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 70-80%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 80-90%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dEta_reco_Centrality_90to100_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dEta_reco_Centrality_90to100_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 800, 'Reco-tracklet #Delta#eta', '', False, simlegtext, ['Centrality 90-100%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dEta_Centrality_90to100_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_data, l_hM_dPhi_reco_sim, padmargin, 'data', True, 750, 'Reco-tracklet #Delta#phi', '', False, simlegtext, [str_clussel], './DataSimComp/{}/RecoTracklet_dPhi'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_altrange_data, l_hM_dPhi_reco_altrange_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 0-100%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_altrange'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_altrange_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dPhi_reco_altrange_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 0-70%, |Asymm._{MBD}|#leq0.75', '-30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dPhi_altrange_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    # Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_0to5_data, l_hM_dPhi_reco_Centrality_0to5_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 0-5%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_0to5'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_5to10_data, l_hM_dPhi_reco_Centrality_5to10_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 5-10%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_5to10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_10to20_data, l_hM_dPhi_reco_Centrality_10to20_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 10-20%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_10to20'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_20to30_data, l_hM_dPhi_reco_Centrality_20to30_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 20-30%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_20to30'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_30to40_data, l_hM_dPhi_reco_Centrality_30to40_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 30-40%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_30to40'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_40to50_data, l_hM_dPhi_reco_Centrality_40to50_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 40-50%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_40to50'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_50to60_data, l_hM_dPhi_reco_Centrality_50to60_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 50-60%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_50to60'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_60to70_data, l_hM_dPhi_reco_Centrality_60to70_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 60-70%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_60to70'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_70to80_data, l_hM_dPhi_reco_Centrality_70to80_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 70-80%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_70to80'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_80to90_data, l_hM_dPhi_reco_Centrality_80to90_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 80-90%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_80to90'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_90to100_data, l_hM_dPhi_reco_Centrality_90to100_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 90-100%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_90to100'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dPhi_reco_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 5-10%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dPhi_reco_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 10-20%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_dPhi_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_dPhi_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', True, 100, 'Reco-tracklet #Delta#phi', '', False, simlegtext, ['Centrality 60-70%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_dPhi_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_dR_reco_data, l_hM_dR_reco_sim, padmargin, 'data', True, 30, 'Reco-tracklet #DeltaR', '', False, simlegtext, ['Centrality 0-100%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_dR'.format(plotdir))
    ...
    Draw_1Dhist_datasimcomp(hM_Eta_reco_data, l_hM_Eta_reco_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 0-100%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_Eta'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 0-70%, |Asymm._{MBD}|#leq0.75', '-30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    # Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_0to5_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_0to5_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 0-5%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_0to5_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 5-10%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_5to10_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 10-20%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_10to20_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_20to30_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_20to30_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 20-30%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_20to30_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_30to40_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_30to40_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 30-40%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_30to40_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 40-50%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_40to50_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 50-60%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_50to60_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 60-70%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_60to70_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 70-80%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_70to80_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 80-90%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_80to90_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Eta_reco_Centrality_90to100_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Eta_reco_Centrality_90to100_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 2, 'Reco-tracklet #eta', '', False, simlegtext, ['Centrality 90-100%, {}'.format(str_clussel), '|Asymm._{MBD}|#leq0.75, -30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Eta_Centrality_90to100_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
    
    for hM_Phi_reco_sim in l_hM_Phi_reco_sim:
        hM_Phi_reco_sim.GetYaxis().SetMaxDigits(2)
    Draw_1Dhist_datasimcomp(hM_Phi_reco_data, l_hM_Phi_reco_sim, padmargin, 'data', False, 1.8, 'Reco-tracklet #phi', '', False, simlegtext, ['Centrality 0-100%, {}'.format(str_clussel)], './DataSimComp/{}/RecoTracklet_Phi'.format(plotdir))
    Draw_1Dhist_datasimcomp(hM_Phi_reco_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10_data, l_hM_Phi_reco_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10_sim, padmargin, 'data', False, 1.8, 'Reco-tracklet #phi', '', False, simlegtext, ['Centrality 0-70%, |Asymm._{MBD}|#leq0.75', '-30#leqZ_{vtx}#leq-10[cm]'], './DataSimComp/{}/RecoTracklet_Phi_Centrality0to70_MBDAsymLe0p75_VtxZm30tom10'.format(plotdir))
