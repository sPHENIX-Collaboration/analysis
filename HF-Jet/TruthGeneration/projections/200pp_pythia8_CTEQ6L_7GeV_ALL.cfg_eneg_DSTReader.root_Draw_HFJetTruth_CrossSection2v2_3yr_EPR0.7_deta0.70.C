...
//=========  (Tue Apr  9 10:39:22 2019) by ROOT version5.34/38
   TCanvas *Draw_HFJetTruth_CrossSection2v2_3yr_EPR0.7_deta0.70 = new TCanvas("Draw_HFJetTruth_CrossSection2v2_3yr_EPR0.7_deta0.70", "Draw_HFJetTruth_CrossSection2v2_3yr_EPR0.7_deta0.70",20,125,700,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: Draw_HFJetTruth_CrossSection2v2_3yr_EPR0.7_deta0.70_1
   ...
   gre->SetPointError(0,0,0.005634446);
   gre->SetPoint(1,21.8,0);
   gre->SetPointError(1,0,0.01354795);
   gre->SetPoint(2,26.8,0);
   gre->SetPointError(2,0,0.03095422);
   gre->SetPoint(3,31.8,0);
   gre->SetPointError(3,0,0.06813101);
   
   TH1F *Graph_ge_h_b_copyv217146369153 = new TH1F("Graph_ge_h_b_copyv217146369153","Graph",100,15.3,33.3);
   Graph_ge_h_b_copyv217146369153->SetMinimum(-0.08175721);
   Graph_ge_h_b_copyv217146369153->SetMaximum(0.08175721);
   ...
   gre->SetPointError(0,0,0.00505066);
   gre->SetPoint(1,23.2,0);
   gre->SetPointError(1,0,0.01214424);
   gre->SetPoint(2,28.2,0);
   gre->SetPointError(2,0,0.02774704);
   gre->SetPoint(3,33.2,0);
   gre->SetPointError(3,0,0.06107194);
   
   TH1F *Graph_ge_h_b_copyv216497604924 = new TH1F("Graph_ge_h_b_copyv216497604924","Graph",100,16.7,34.7);
   Graph_ge_h_b_copyv216497604924->SetMinimum(-0.07328633);
   Graph_ge_h_b_copyv216497604924->SetMaximum(0.07328633);
