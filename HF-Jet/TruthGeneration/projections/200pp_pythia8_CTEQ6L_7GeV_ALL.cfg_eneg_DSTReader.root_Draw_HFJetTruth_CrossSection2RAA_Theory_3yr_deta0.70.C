...
//=========  (Tue Apr  9 10:39:21 2019) by ROOT version5.34/38
   TCanvas *Draw_HFJetTruth_CrossSection2RAA_Theory_3yr_deta0.70 = new TCanvas("Draw_HFJetTruth_CrossSection2RAA_Theory_3yr_deta0.70", "Draw_HFJetTruth_CrossSection2RAA_Theory_3yr_deta0.70",16,105,700,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: Draw_HFJetTruth_CrossSection2RAA_Theory_3yr_deta0.70_1
   ...
   Graph_Graph_RAA_h_b_copy168169277712->SetMinimum(-0.2297644);
   Graph_Graph_RAA_h_b_copy168169277712->SetMaximum(1.429764);
