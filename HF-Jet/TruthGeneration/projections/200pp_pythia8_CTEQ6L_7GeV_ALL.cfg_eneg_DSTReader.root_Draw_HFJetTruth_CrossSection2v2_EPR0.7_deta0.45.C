{
//=========Macro generated from canvas: Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45/Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45
//=========  (Mon Dec  4 09:14:06 2017) by ROOT version5.34/36
   TCanvas *Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45 = new TCanvas("Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45", "Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45",20,135,700,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->Range(0,0,1,1);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetFillColor(0);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetBorderMode(0);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetBorderSize(2);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetTickx(1);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetTicky(1);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetLeftMargin(0.16);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetRightMargin(0.05);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetTopMargin(0.05);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetBottomMargin(0.16);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1
   TPad *Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1 = new TPad("Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1", "Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1",0.01,0.01,0.99,0.99);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->Draw();
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->cd();
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->Range(9.936709,-0.1810127,41.58228,0.3253165);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetFillColor(0);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetBorderMode(0);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetBorderSize(2);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetTickx(1);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetTicky(1);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetLeftMargin(0.16);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetRightMargin(0.05);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetTopMargin(0.05);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetBottomMargin(0.16);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetFrameBorderMode(0);
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->SetFrameBorderMode(0);
   ...
   gre->SetPointError(0,0,0.005367257);
   gre->SetPoint(1,21.8,0);
   gre->SetPointError(1,0,0.0129055);
   gre->SetPoint(2,26.8,0);
   gre->SetPointError(2,0,0.02948635);
   gre->SetPoint(3,31.8,0);
   gre->SetPointError(3,0,0.06490019);
   
   TH1F *Graph_ge_h_b_copyv217146369153 = new TH1F("Graph_ge_h_b_copyv217146369153","Graph",100,15.3,33.3);
   Graph_ge_h_b_copyv217146369153->SetMinimum(-0.07788023);
   Graph_ge_h_b_copyv217146369153->SetMaximum(0.07788023);
   ...
   gre->SetPointError(0,0,0.004811154);
   gre->SetPoint(1,23.2,0);
   gre->SetPointError(1,0,0.01156836);
   gre->SetPoint(2,28.2,0);
   gre->SetPointError(2,0,0.02643126);
   gre->SetPoint(3,33.2,0);
   gre->SetPointError(3,0,0.05817587);
   
   TH1F *Graph_ge_h_b_copyv216497604924 = new TH1F("Graph_ge_h_b_copyv216497604924","Graph",100,16.7,34.7);
   Graph_ge_h_b_copyv216497604924->SetMinimum(-0.06981104);
   Graph_ge_h_b_copyv216497604924->SetMaximum(0.06981104);
   ...
   entry->SetTextFont(42);
   leg->Draw();
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45_1->Modified();
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->cd();
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->Modified();
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->cd();
   Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45->SetSelected(Draw_HFJetTruth_CrossSection2v2_EPR0.7_deta0.45);
}
