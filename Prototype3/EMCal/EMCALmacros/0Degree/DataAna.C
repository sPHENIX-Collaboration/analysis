...
if(j == 1 || j == 3 || j == 5) sprintf(Title,"10 X Bin Average Energy vs Horizontal Position Tower Between %d and %d",k,l);

if(j == 0 || j == 2 || j == 4 || j == 6 ) sprintf(Title,"10 X Bin Average Energy vs Horizontal Position Tower %d",m);
...
sprintf(outname,"Result/Energy vs 10-Bin Average X %d.png",j);
