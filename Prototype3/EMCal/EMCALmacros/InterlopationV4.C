...
EnPo->SetTitle("Energy vs Horizontal and Vertical Positions Before Interpolation - 10 Degree");

EnPo->Draw("colz");
c1->Update();

c1->SaveAs("Before10Degree.png");
...
Inter->SetTitle("Energy vs Horizontal and Vertical Positions Before Interpolation - 10 Degree");
...
// Horizontal line Tower 1 //
 ...
 TLatex* texCol;
texCol= new TLatex(Xmin,y1,"Tower 6");
...
texCol= new TLatex(Xmin,y2,"Tower 5");
  texCol->SetTextAlign(13);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
...
texCol= new TLatex(Xmin,y3,"Tower 4");
  texCol->SetTextAlign(13);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
...
texCol= new TLatex(Xmin,y4,"Tower 3");
  texCol->SetTextAlign(13);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
...
texCol= new TLatex(Xmin,y5,"Tower 2");
  texCol->SetTextAlign(13);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
 ...
 TLatex* texCol;
texCol= new TLatex(Xmin,215,"Tower 1");
  texCol->SetTextAlign(13);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
...
// Vertical line Tower 1 //
 ...
 TLatex* texCol;
texCol= new TLatex(x1,Ymax,"Tower 6");
...
// Horizontal line Tower 2 //
 ...
 TLatex* texCol;
texCol= new TLatex(x2,Ymax,"Tower 5");
  texCol->SetTextAlign(33);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
...
// Horizontal line Tower 3//
 ...
 TLatex* texCol;
texCol= new TLatex(x3,Ymax,"Tower 4");
  texCol->SetTextAlign(33);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
...
// Horizontal line Tower 4 //
 ...
 TLatex* texCol;
texCol= new TLatex(x4,Ymax,"Tower 3");
  texCol->SetTextAlign(33);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
 ...
 TLatex* texCol;
texCol= new TLatex(x5,Ymax,"Tower 2");
  texCol->SetTextAlign(33);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
 ...
 TLatex* texCol;
texCol= new TLatex(Xmax,Ymax,"Tower 1");
  texCol->SetTextAlign(33);
  texCol->SetTextSize(0.03);
 texCol->SetTextFont(42);
  texCol->Draw();
...
c22->SaveAs("Interpolation10Degree.png");
