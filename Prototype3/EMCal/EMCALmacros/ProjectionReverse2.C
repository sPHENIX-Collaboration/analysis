...
Inter->SetTitle("Energy vs Horizontal and Vertical Positions After Interpolation - 10 Degree");
...
c22->cd();
   ...
   l2->SetLineWidth(2);
   l2->Draw("same");
sprintf(Outname,"Result2/HorizontalPlot%d.png",i);
