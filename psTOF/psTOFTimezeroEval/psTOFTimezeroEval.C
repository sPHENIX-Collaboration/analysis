...
#include "../../psTOF/psTOFTimezeroEval/psTOFTimezeroEval.h"

using namespace std;

psTOFTimezeroEval::psTOFTimezeroEval(const string &name, const string &filename) :
  SubsysReco("psTOFTimezeroEval"),
  _ievent(0),
...
int psTOFTimezeroEval::Init(PHCompositeNode *topNode) {
...
int psTOFTimezeroEval::InitRun(PHCompositeNode *topNode) {
  return Fun4AllReturnCodes::EVENT_OK;
}
  
int psTOFTimezeroEval::process_event(PHCompositeNode *topNode) {
  
  if ((verbosity > 0)&&(_ievent%100==0)) {
    cout << "psTOFTimezeroEval::process_event - Event = " << _ievent << endl;
  }
...
int psTOFTimezeroEval::End(PHCompositeNode *topNode) {
  ...
  if (verbosity >  0) {
    cout << "========================= psTOFTimezeroEval::End() ============================" << endl;
  ...
  if (verbosity > -1) {
    if ((_errors > 0)||(verbosity > 0)) {
      cout << "psTOFTimezeroEval::End() - Error Count: " << _errors << endl;
    }
  }
...
void psTOFTimezeroEval::printInputInfo(PHCompositeNode *topNode) {
  
  if (verbosity > 1) cout << "psTOFTimezeroEval::printInputInfo() entered" << endl;
...
void psTOFTimezeroEval::printOutputInfo(PHCompositeNode *topNode) {
  
  if (verbosity > 1) cout << "psTOFTimezeroEval::printOutputInfo() entered" << endl;
...
void psTOFTimezeroEval::fillOutputNtuples(PHCompositeNode *topNode) {

  if (verbosity > 1) cout << "psTOFTimezeroEval::fillOutputNtuples() entered" << endl;
