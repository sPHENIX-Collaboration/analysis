...
///
class psTOFTimezeroEval : public SubsysReco {
  
public:
 
  psTOFTimezeroEval(const std::string &name = "SVTXEVALUATOR",
                const std::string &filename = "g4eval.root");
  virtual ~psTOFTimezeroEval() {}
