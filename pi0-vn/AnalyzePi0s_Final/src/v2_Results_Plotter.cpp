...
void v2_Results_Plotter() {
    ...
    ReadStatUncertainties(statUncertaintyFilePath, data1); //read total systematic uncertainty CSV

    plotting_Results_andPHENIXoverlay(data1); //plot final results and PHENIX overlay
    plotting_Systematics(data1); //plot total systematic contributions
