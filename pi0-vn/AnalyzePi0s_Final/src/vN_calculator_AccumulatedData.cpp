...
void Plot_vN() {
    ...
    graph_0_20_v2->SetMinimum(-0.2); // Set the minimum y value
    graph_0_20_v2->SetMaximum(0.5); // Set the maximum y value
    c1->SetTicks();
    ...
    bg_graph_0_20_v2->SetMinimum(-0.2); // Set the minimum y value
    bg_graph_0_20_v2->SetMaximum(0.5); // Set the maximum y value
    c4->SetTicks();
    TLatex latex020_bg;
    ...
    bg_graph_0_20_v2->SetMinimum(0.05); // Set the minimum y value
    ...
    TLegend *legend_leftRightbg_overlay_0_20_v2 = new TLegend(0.12, 0.65, 0.32, 0.85);
    legend_leftRightbg_overlay_0_20_v2->SetBorderSize(0);
    legend_leftRightbg_overlay_0_20_v2->SetTextSize(0.024);
    ...
    corrected_graph_20_40_v2->SetTitle("Background #it{v}_{2} vs #it{p}_{T} 20-40% Centrality; #it{p}_{T} [GeV]; #it{v}_{2}");
    ...
    TLegend* legend0_20_corr_uncorr_overlay_v2 = new TLegend(0.1, 0.65, 0.4, 0.9);
    legend0_20_corr_uncorr_overlay_v2->AddEntry(graph_0_20_v2, "#bf{v_{2}^{M}} (Uncorrected)", "p");
    legend0_20_corr_uncorr_overlay_v2->AddEntry(corrected_graph_0_20_v2, "#bf{v_{2}^{#pi^{0}}} (Corrected)", "p");
    legend0_20_corr_uncorr_overlay_v2->AddEntry(graph_0_10, "0-10% #bf{PHENIX} 2010", "p");
    legend0_20_corr_uncorr_overlay_v2->AddEntry(graph_10_20, "10-20% #bf{PHENIX} 2010", "p");
    ...
    TLegend* legend20_40_corr_uncorr_overlay_v2 = new TLegend(0.1, 0.65, 0.5, 0.9);
    // Set the text font and size for the legend
    legend20_40_corr_uncorr_overlay_v2->SetTextFont(42);
    legend20_40_corr_uncorr_overlay_v2->SetTextSize(0.03); // Decrease this number to make the font smaller

    // Reposition the legend to avoid squishing to the right border
    // The coordinates are in NDC (Normalized Device Coordinates), (0,0) is bottom-left and (1,1) is top-right of the canvas.
    legend20_40_corr_uncorr_overlay_v2->SetX1NDC(0.08); // Set to a larger value if it's too close to the left border
    legend20_40_corr_uncorr_overlay_v2->SetX2NDC(0.3); // Set to a smaller value if it's too close to the right border
    legend20_40_corr_uncorr_overlay_v2->SetY1NDC(0.65); // Adjust if necessary
    legend20_40_corr_uncorr_overlay_v2->SetY2NDC(0.85); // Adjust if necessary to control the height

    // Set the label offset for the graphs
    corrected_graph_20_40_v2->GetXaxis()->SetLabelOffset(0.02); // Change the offset value to move closer or further away
    corrected_graph_20_40_v2->GetYaxis()->SetLabelOffset(0.02); // Change the offset value to move closer or further away
    ...
    corrected_graph_40_60_v2->SetMaximum(1.2); // Set the maximum y value
    ...
    // Legend
    TLegend* legend40_60_corr_uncorr_overlay_v2 = new TLegend(0.1, 0.65, 0.45, 0.9);
