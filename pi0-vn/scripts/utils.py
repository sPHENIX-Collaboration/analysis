...
f4a.add_argument('-m', '--macro', type=str, default='macro/Fun4All/Fun4All_CaloTreeGen.C', help='Fun4All macro. Default: macro/Fun4All/Fun4All_CaloTreeGen.C')
...
pi0Ana.add_argument('-m', '--macro', type=str, default='macro/pi0-Analysis/pi0Analysis.C', help='pi0Analysis macro. Default: macro/pi0-Analysis/pi0Analysis.C')
pi0Ana.add_argument('-e', '--script', type=str, default='scripts/genPi0Ana.sh', help='Job script to execute. Default: scripts/genPi0Ana.sh')
...
truthPi0Ana.add_argument('-m', '--macro', type=str, default='macro/pi0-Analysis/truthPi0Analysis.C', help='pi0Analysis macro. Default: macro/pi0-Analysis/truthPi0Analysis.C')
truthPi0Ana.add_argument('-e', '--script', type=str, default='scripts/genTruthPi0Ana.sh', help='Job script to execute. Default: scripts/genTruthPi0Ana.sh')
...
mix.add_argument('-m', '--macro', type=str, default='macro/mixed-event/mixedEvent.C', help='Mixed Event macro. Default: macro/mixedEvent.C')
mix.add_argument('-e', '--script', type=str, default='scripts/genMixedEvent.sh', help='Job script to execute. Default: scripts/genMixedEvent.sh')
...
QVecCorr.add_argument('-m', '--macro', type=str, default='macro/vn-Analysis/Q-vector-correction.C', help='Q Vector Correction macro. Default: macro/vn-Analysis/Q-vector-correction.C')
QVecCorr.add_argument('-z', '--vtx-z', type=float, default=10, help='Event z-vertex cut. Default: 10 [cm]')
QVecCorr.add_argument('-e', '--script', type=str, default='scripts/genQVecCorr.sh', help='Job script to execute. Default: scripts/genQVecCorr.sh')
