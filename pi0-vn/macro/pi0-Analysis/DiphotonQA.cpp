...
void DiphotonQA() {
    ...
    std::string rootFilePath = userPath + "/p015/DiphotonQA_truthPI0/test.root";
    std::string outputBasePath = userPath + "/p015/QA/Diphoton/TRUTHpi0/";
    ...
    const char* folderNames[] = {"h2Pi0EtaPhi"};
...
//    };
    ...
    for (int i = 0; i < numFolders; ++i) {
        ...
        for (int histIndex = 0; histIndex < 6; ++histIndex) {
...
//            hist->GetZaxis()->SetRangeUser(0, 3200);
