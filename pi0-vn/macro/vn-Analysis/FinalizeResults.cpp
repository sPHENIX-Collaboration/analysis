...
TGraphErrors* CreateSystematicGraph(const std::vector<double>& ptCenters,
    ...
    std::vector<double> sysx(ptCenters.size(), 0.05);//.025
...
void plotting_Results_andPHENIXoverlay(const Data& data1) {
    ...
    setGraphProperties(corrected_v2_0_20_graph_1, kBlack, kBlack, 1.4, 20);
    setGraphProperties(corrected_v2_20_40_graph_1, kBlack, kBlack, 1.4, 20);
    setGraphProperties(corrected_v2_40_60_graph_1, kBlack, kBlack, 1.4, 20);
    ...
    */
    auto create_sPHENIX_Results = [&data1](TCanvas* canvas, TGraphErrors* graph1, TGraphErrors* graph2,  const std::string& centrality) {
        graph1->GetYaxis()->SetRangeUser(-0.15, maxYaxis);
        ...
        DrawZeroLine(canvas);
        Create_sPHENIX_legend_Results(canvas, 0.14, 0.72, 0.34, 0.92, centrality.c_str(), 0.045);
    };
    ...
    setGraphProperties(graph_0_20_PHENIXdataAveraged, kRed, kRed, 1.0, 20);
    setGraphProperties(graph_20_40_PHENIXdataAveraged, kRed, kRed, 1.0, 20);
    setGraphProperties(graph_40_60_PHENIXdataAveraged, kRed, kRed, 1.0, 20);
    ...
    sys_graph_0_20_PHENIX->SetFillColor(kRed);
    ...
    sys_graph_20_40_PHENIX->SetFillColor(kRed);
    ...
    sys_graph_40_60_PHENIX->SetFillColor(kRed);
    ...
    for (int i = 0; i < ptCenters.size(); ++i) {
        sys_v2_0_20_graph_1->SetPoint(i, ptCenters[i] - .04, data1.corrected_v2_0_20[i]);
        corrected_v2_0_20_graph_1->SetPoint(i, ptCenters[i] - .04, data1.corrected_v2_0_20[i]);
        
        graph_0_20_PHENIXdataAveraged->SetPoint(i, ptCenters[i] + .04, combinedData.v2_0_20_PHENIX[i]);
        sys_graph_0_20_PHENIX->SetPoint(i, ptCenters[i] + .04, combinedData.v2_0_20_PHENIX[i]);
        
        sys_v2_20_40_graph_1->SetPoint(i, ptCenters[i] - .04, data1.corrected_v2_20_40[i]);
        corrected_v2_20_40_graph_1->SetPoint(i, ptCenters[i] - .04, data1.corrected_v2_20_40[i]);
        
        graph_20_40_PHENIXdataAveraged->SetPoint(i, ptCenters[i] + .04, combinedData.v2_20_40_PHENIX[i]);
        sys_graph_20_40_PHENIX->SetPoint(i, ptCenters[i] + .04, combinedData.v2_20_40_PHENIX[i]);
        
        sys_v2_40_60_graph_1->SetPoint(i, ptCenters[i] - .04, data1.corrected_v2_40_60[i]);
        corrected_v2_40_60_graph_1->SetPoint(i, ptCenters[i] - .04, data1.corrected_v2_40_60[i]);
        
        graph_40_60_PHENIXdataAveraged->SetPoint(i, ptCenters[i] + .04, combinedData.v2_40_60_PHENIX[i]);
        sys_graph_40_60_PHENIX->SetPoint(i, ptCenters[i] + .04, combinedData.v2_40_60_PHENIX[i]);
    }
    ...
    auto create_PHENIX_sPHENIX_graph = [&data1](TCanvas* canvas, TGraphErrors* graph1, TGraphErrors* graph2, TGraphErrors* graph3, TGraphErrors* graph4,  const std::string& centrality) {
        ...
        leg->SetTextSize(0.029);
        leg->AddEntry(graph2, "sPHENIX", "pe");
        leg->AddEntry(graph4, "PHENIX", "pe");
        leg->Draw("same");
    };
...
void plot_HijingOverlay(const Data& data1, Data& data2) {
    std::array<GraphProperties, 2> properties = {{
        {kBlack, 20, 1.0},
        {kBlue, 20, 1.0}
    }};
    ...
    std::vector<std::string> descriptions = {"Default Data", "Hijing"};
    logGraphData(allGraphs, descriptions, centralityLabels, ptCenters);
     ...
     */
    TCanvas *c_Overlay_0_20_sampleSizeVariation = new TCanvas("c_Overlay_0_20_sampleSizeVariation", "#pi^{0} #it{v}_{2} vs #it{p}_{T} 40-60% Centrality", 800, 600);
    createAndDraw_2graphEntries(c_Overlay_0_20_sampleSizeVariation, corrected_v2_0_20_graph_1, corrected_v2_0_20_graph_2, "Hijing", "Default", 0.2, 0.18, 0.4, 0.33, "0-20% Centrality");
    c_Overlay_0_20_sampleSizeVariation->Modified();
    c_Overlay_0_20_sampleSizeVariation->Update();
    c_Overlay_0_20_sampleSizeVariation->SaveAs((baseDataPath_SampleSizeVariations + "Overlay_0_20_v2_sampleSizeVariations.png").c_str());

    TCanvas *c_Overlay_20_40_sampleSizeVariation = new TCanvas("c_Overlay_20_40_sampleSizeVariation", "#pi^{0} #it{v}_{2} vs #it{p}_{T} 40-60% Centrality", 800, 600);
    createAndDraw_2graphEntries(c_Overlay_20_40_sampleSizeVariation, corrected_v2_20_40_graph_1, corrected_v2_20_40_graph_2, "Hijing", "Default", 0.2, 0.18, 0.4, 0.33, "20-40% Centrality");
    c_Overlay_20_40_sampleSizeVariation->Modified();
    c_Overlay_20_40_sampleSizeVariation->Update();
    c_Overlay_20_40_sampleSizeVariation->SaveAs((baseDataPath_SampleSizeVariations + "Overlay_20_40_v2_sampleSizeVariations.png").c_str());

    TCanvas *c_Overlay_40_60_sampleSizeVariation = new TCanvas("c_Overlay_40_60_sampleSizeVariation", "#pi^{0} #it{v}_{2} vs #it{p}_{T} 40-60% Centrality", 800, 600);
    createAndDraw_2graphEntries(c_Overlay_40_60_sampleSizeVariation, corrected_v2_40_60_graph_1, corrected_v2_40_60_graph_2, "Hijing", "30 Samples (Default)", 0.2, 0.18, 0.4, 0.33, "40-60% Centrality");
    c_Overlay_40_60_sampleSizeVariation->Modified();
    c_Overlay_40_60_sampleSizeVariation->Update();
    c_Overlay_40_60_sampleSizeVariation->SaveAs((baseDataPath_SampleSizeVariations + "Overlay_40_60_v2_sampleSizeVariations.png").c_str());
}
...
void plotProduction_Comparisons(const Data& data1, Data& data2) {
    ...
    createAndDraw_2graphEntries(c_Overlay_0_20_productionComparisons_corrected, corrected_v2_0_20_graph_1, corrected_v2_0_20_graph_2, "Hijing v_{2}^{#pi^{0}}", "p015 v_{2}^{#pi^{0}}", 0.2, 0.18, 0.4, 0.33, "0-20% Centrality");
    ...
    createAndDraw_2graphEntries(c_Overlay_20_40_productionComparisons_corrected, corrected_v2_20_40_graph_1, corrected_v2_20_40_graph_2, "Hijing v_{2}^{#pi^{0}}", "p015 v_{2}^{#pi^{0}}", 0.2, 0.18, 0.4, 0.33, "20-40% Centrality");
    ...
    createAndDraw_2graphEntries(c_Overlay_40_60_productionComparisons_corrected, corrected_v2_40_60_graph_1, corrected_v2_40_60_graph_2, "Hijing v_{2}^{#pi^{0}}", "p015 v_{2}^{#pi^{0}}", 0.2, 0.18, 0.4, 0.33, "40-60% Centrality");
    ...
    createAndDraw_2graphEntries(c_Overlay_0_20_productionComparisons_signal, signal_v2_0_20_graph_1, signal_v2_0_20_graph_2, "Hijing v_{2}^{measured}", "p015 v_{2}^{measured}", 0.2, 0.18, 0.4, 0.33, "0-20% Centrality");
    ...
    createAndDraw_2graphEntries(c_Overlay_20_40_productionComparisons_signal, signal_v2_20_40_graph_1, signal_v2_20_40_graph_2, "Hijing v_{2}^{measured}", "p015 v_{2}^{measured}", 0.2, 0.18, 0.4, 0.33, "20-40% Centrality");
    ...
    createAndDraw_2graphEntries(c_Overlay_40_60_productionComparisons_signal, signal_v2_40_60_graph_1, signal_v2_40_60_graph_2, "Hijing v_{2}^{measured}", "p015 v_{2}^{measured}", 0.2, 0.18, 0.4, 0.33, "40-60% Centrality");
    ...
    createAndDraw_2graphEntries(c_Overlay_0_20_productionComparisons_bg, bg_v2_0_20_graph_1, bg_v2_0_20_graph_2, "Hijing v_{2}^{BG}", "p015 v_{2}^{BG}", 0.2, 0.18, 0.4, 0.33, "0-20% Centrality");
    ...
    createAndDraw_2graphEntries(c_Overlay_20_40_productionComparisons_bg, bg_v2_20_40_graph_1, bg_v2_20_40_graph_2, "Hijing v_{2}^{BG}", "p015 v_{2}^{BG}", 0.2, 0.18, 0.4, 0.33, "20-40% Centrality");
    ...
    createAndDraw_2graphEntries(c_Overlay_40_60_productionComparisons_bg, bg_v2_40_60_graph_1, bg_v2_40_60_graph_2, "Hijing v_{2}^{BG}", "p015 v_{2}^{BG}", 0.2, 0.18, 0.4, 0.33, "40-60% Centrality");
...
void initializePaths() {
    ...
    p013_filePath = userPath + "/vn-hijing-0-20fm.csv"; //for production comparison
