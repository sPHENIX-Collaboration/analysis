...
def makeCondorJob():
    ...
    condorFile.write("Executable         = $(initialDir)/run_MDC2reco.sh\n")
    condorFile.write("PeriodicHold       = (NumJobStarts>=1 && JobStatus == 1)\n")
    condorFile.write("request_memory     = 4000MB\n")
    ...
    condorFile.write("Log                = /tmp/dillfitz/condor-{0}-$INT(Process,%05d).log\n".format(inputType))
